...
var To = (s, t) => (typeof s == 'string' && s.endsWith('%') ? parseFloat(s) / 100 : s / t),
    Tn = (s, t) => (typeof s == 'string' && s.endsWith('%') ? (parseFloat(s) / 100) * t : +s);
function j(s, t, e) {
...
function H(s, t, e, i) {
    let n, r, o;
    if ($(s))
        if (((r = s.length), i)) for (n = r - 1; n >= 0; n--) t.call(e, s[n], n);
        else for (n = 0; n < r; n++) t.call(e, s[n], n);
    else if (A(s))
        for (o = Object.keys(s), r = o.length, n = 0; n < r; n++) t.call(e, s[o[n]], o[n]);
}
function xs(s, t) {
    let e, i, n, r;
    if (!s || !t || s.length !== t.length) return !1;
    for (e = 0, i = s.length; e < i; ++e)
        if (((n = s[e]), (r = t[e]), n.datasetIndex !== r.datasetIndex || n.index !== r.index))
            return !1;
    return !0;
}
function _i(s) {
...
function Mc(s, t, e) {
    ...
    let i = t[s],
        n = e[s];
    A(i) && A(n) ? Pe(i, n) : Object.prototype.hasOwnProperty.call(t, s) || (t[s] = _i(n));
}
...
function Dn(s, t, e) {
    ...
    for (i = 0, n = s.length; i < n; i++)
        (r = s[i][e]), isNaN(r) || ((t.min = Math.min(t.min, r)), (t.max = Math.max(t.max, r)));
}
function wt(s) {
    return s * (Y / 180);
}
...
var Oi = (s) => (s === 'start' ? 'left' : s === 'end' ? 'right' : 'center'),
    ...
    No = (s, t, e, i) => (s === (i ? 'left' : 'right') ? e : s === 'center' ? (t + e) / 2 : t);
function Pn(s, t, e) {
    let i = t.length,
        n = 0,
        r = i;
    if (s._sorted) {
        ...
        u &&
            (n = it(
                Math.min(Ct(a, o.axis, c).lo, e ? i : Ct(t, l, o.getPixelForValue(c)).lo),
                0,
                i - 1,
            )),
            d
...
function Nn(s) {
    ...
    let r = i.xmin !== t.min || i.xmax !== t.max || i.ymin !== e.min || i.ymax !== e.max;
    return Object.assign(i, n), r;
}
var gi = (s) => s === 0 || s === 1,
    uo = (s, t, e) => -(Math.pow(2, 10 * (s -= 1)) * Math.sin(((s - t) * B) / e)),
    ...
    Ie = {
        ...
        easeInOutBounce: (s) =>
            s < 0.5 ? Ie.easeInBounce(s * 2) * 0.5 : Ie.easeOutBounce(s * 2 - 1) * 0.5 + 0.5,
    };
function _s(s) {
    return (s + 0.5) | 0;
}
...
function Ro(s, t, e) {
    let i = t * Math.min(e, 1 - e),
        n = (r, o = (r + s / 30) % 12) => e - i * Math.max(Math.min(o - 3, 9 - o, 1), -1);
    return [n(0), n(8), n(4)];
}
function Rc(s, t, e) {
    let i = (n, r = (n + s / 60) % 6) => e - e * t * Math.max(Math.min(r, 4 - r, 1), 0);
    return [i(5), i(3), i(1)];
}
function Wc(s, t, e) {
    let i = Ro(s, 1, 0.5),
...
function Bc(s) {
    ...
    let n = Wo(+t[2]),
        ...
        o = +t[4] / 100;
    return (
        t[1] === 'hwb' ? (i = Vc(n, r, o)) : t[1] === 'hsv' ? (i = Hc(n, r, o)) : (i = zn(n, r, o)),
        { r: i[0], g: i[1], b: i[2], a: e }
    );
}
function $c(s, t) {
    var e = Rn(s);
    (e[0] = Wo(e[0] + t)), (e = zn(e)), (s.r = e[0]), (s.g = e[1]), (s.b = e[2]);
}
function jc(s) {
    if (!s) return;
    let t = Rn(s),
...
function Uc() {
    ...
    for (i = 0; i < t.length; i++) {
        for (o = a = t[i], n = 0; n < e.length; n++) (r = e[n]), (a = a.replace(r, go[r]));
        (r = parseInt(po[o], 16)), (s[a] = [(r >> 16) & 255, (r >> 8) & 255, r & 255]);
    }
    return s;
}
var yi;
...
var xn = (s) => (s <= 0.0031308 ? s * 12.92 : Math.pow(s, 1 / 2.4) * 1.055 - 0.055),
...
var Fe = class {
    constructor(t) {
        ...
        let e = typeof t,
            i;
        e === 'object' ? (i = yo(t)) : e === 'string' && (i = Ac(t) || Yc(t) || Kc(t)),
            (this._rgb = i),
            (this._valid = !!i);
    }
    get valid() {
...
function bs(s, t, e, i, n) {
    let r = t[n];
    return r || ((r = t[n] = s.measureText(n).width), e.push(n)), r > i && (i = r), i;
}
function Bo(s, t, e, i) {
    i = i || {};
    let n = (i.data = i.data || {}),
        r = (i.garbageCollect = i.garbageCollect || []);
    i.font !== t && ((n = i.data = {}), (r = i.garbageCollect = []), (i.font = t)),
        s.save(),
        (s.font = t);
    let o = 0,
        a = e.length,
...
function We(s, t) {
    ...
    s.arc(e + o.topLeft, i + o.topLeft, o.topLeft, -Z, Y, !0),
        ...
        s.arc(e + n - o.bottomRight, i + r - o.bottomRight, o.bottomRight, Z, 0, !0),
...
var eh = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
    sh = new RegExp(/^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/);
function ih(s, t) {
    let e = ('' + s).match(eh);
...
function ah(s, t, e, i) {
    ...
    return a.add(s), (t = t(r, o || i)), a.delete(s), Un(s, t) && (t = Yn(n._scopes, n, s, t)), t;
}
function lh(s, t, e, i) {
...
function Yn(s, t, e, i) {
    ...
    return l === null || (ft(r) && r !== e && ((l = bo(a, o, r, l, i)), l === null))
        ? !1
...
function dh(s, t, e, i) {
    let n;
    for (let r of t) if (((n = qo(rh(r, s), e)), ft(n))) return Un(s, n) ? Yn(e, i, s, n) : n;
}
function qo(s, t) {
    for (let e of t) {
        if (!e) continue;
...
function Zn(s, t, e, i) {
    let { iScale: n } = s,
        ...
        c,
        h;
    for (a = 0, l = i; a < l; ++a) (c = a + e), (h = t[c]), (o[a] = { r: n.parse(Bt(h, r), c) });
    return o;
}
    ...
    for (let h = 0; h < i - 1; ++h)
        if (((l = c), (c = Le(s, h + 1)), !(!l || !c))) {
            ...
            (n = e[h] / t[h]),
                ...
                !(a <= 9) &&
                    ((o = 3 / Math.sqrt(a)), (e[h] = n * o * t[h]), (e[h + 1] = r * o * t[h]));
        }
}
function yh(s, t, e = 'x') {
    let i = Go(e),
    ...
    for (let c = 0; c < n; ++c) {
        ...
        let h = a[e],
            u = a[i];
        o && ((r = (h - o[e]) / 3), (a[`cp1${e}`] = h - r), (a[`cp1${i}`] = u - r * t[c])),
            l && ((r = (l[e] - h) / 3), (a[`cp2${e}`] = h + r), (a[`cp2${i}`] = u + r * t[c]));
    }
}
function bh(s, t = 'x') {
    let e = Go(t),
...
function Xo(s, t, e, i, n) {
    ...
    if ((t.spanGaps && (s = s.filter((c) => !c.skip)), t.cubicInterpolationMode === 'monotone'))
        ...
        for (r = 0, o = s.length; r < o; ++r)
            (a = s[r]),
                (l = gh(c, a, s[Math.min(r + 1, o - (i ? 0 : 1)) % o], t.tension)),
                (a.cp1x = l.previous.x),
                (a.cp1y = l.previous.y),
                (a.cp2x = l.next.x),
                (a.cp2y = l.next.y),
...
function Gn(s, t, e) {
    ...
    return (
        o.style &&
            ...
            ((o.style.height = `${s.height}px`), (o.style.width = `${s.width}px`)),
...
function wo({ start: s, end: t, count: e, loop: i, style: n }) {
    return { start: s % e, end: t % e, loop: i && (t - s + 1) % e === 0, style: n };
}
function Dh(s, t, e) {
    let { property: i, start: n, end: r } = e,
        ...
        f;
    if (u) {
        for (c += l, h += l, d = 0, f = l; d < f && o(a(t[c % l][i]), n, r); ++d) c--, h--;
        (c %= l), (h %= l);
    }
        ...
        (b = t[O % o]),
            !b.skip &&
                ...
                y !== _ &&
                    ...
                    p !== null &&
                        k() &&
                        (m.push(wo({ start: p, end: O, loop: d, count: o, style: f })), (p = null)),
                    (T = O),
                    (_ = y)));
    return p !== null && m.push(wo({ start: p, end: u, loop: d, count: o, style: f })), m;
}
function tr(s, t) {
    let e = [],
        i = s.segments;
...
function Ch(s, t, e, i) {
    ...
    function f(m, g, p, y) {
        ...
        if (m !== g) {
            ...
            for (; e[g % l].skip; ) g += b;
            m % l !== g % l &&
                (c.push({ start: m % l, end: g % l, loop: p, style: y }), (h = y), (u = g % l));
        }
    }
    for (let m of t) {
        u = a ? u : m.start;
...
function ra(s, t, e, i = {}) {
    ...
    if (t !== null) {
        for (o = 0, a = n.length; o < a; ++o) {
            ...
            (c = s.values[l]), K(c) && (r || t === 0 || Tt(t) === Tt(c)) && (t += c);
        }
        return t;
    }
}
function Hh(s) {
    let t = Object.keys(s),
        ...
        n,
        r;
    for (i = 0, n = t.length; i < n; ++i) (r = t[i]), (e[i] = { x: r, y: s[r] });
    return e;
}
function oa(s, t) {
...
function $h(s) {
    ...
    return { min: i ? t : Number.NEGATIVE_INFINITY, max: n ? e : Number.POSITIVE_INFINITY };
}
function jh(s, t, e) {
    let i = s[t] || (s[t] = {});
    return i[e] || (i[e] = {});
...
var sr = (s) => s === 'reset' || s === 'none',
    ...
    Zh = (s, t, e) => s && !t.hidden && t._stacked && { keys: qa(e, !0), values: null },
    pt = class {
        constructor(t, e) {
            (this.chart = t),
                (this._ctx = t.ctx),
        ...
        initialize() {
            ...
            this.configure(), this.linkScales(), (t._stacked = oa(t.vScale, t)), this.addElements();
        }
        updateIndex(t) {
        ...
        parsePrimitiveData(t, e, i, n) {
            let { iScale: r, vScale: o } = t,
                ...
                m;
            for (d = 0, f = n; d < f; ++d)
                (m = d + i), (u[d] = { [a]: h || r.parse(c[m], m), [l]: o.parse(e[m], m) });
            return u;
        }
        parseArrayData(t, e, i, n) {
            let { xScale: r, yScale: o } = t,
                ...
                u;
            for (l = 0, c = n; l < c; ++l)
                (h = l + i), (u = e[h]), (a[l] = { x: r.parse(u[0], h), y: o.parse(u[1], h) });
            return a;
        }
        parseObjectData(t, e, i, n) {
            ...
            for (h = 0, u = n; h < u; ++h)
                (d = h + i),
                    (f = e[d]),
                    (c[h] = { x: r.parse(Bt(f, a), d), y: o.parse(Bt(f, l), d) });
            return c;
        }
        getParsed(t) {
        ...
        getAllParsedValues(t) {
            let e = this._cachedMeta._parsed,
                ...
                r,
                o;
            for (n = 0, r = e.length; n < r; ++n) (o = e[n][t.axis]), K(o) && i.push(o);
            return i;
        }
        getMaxOverflow() {
            return !1;
        ...
        _update(t) {
            ...
            this.update(t || 'default'),
                (e._clip = Vh(I(this.options.clip, zh(e.xScale, e.yScale, this.getMaxOverflow()))));
        }
        update(t) {}
        draw() {
            let t = this._ctx,
        ...
        getContext(t, e, i) {
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                (r = this.$context || (this.$context = Uh(this.chart.getContext(), this.index))),
                    (r.dataset = n),
        ...
        _resolveElementOptions(t, e = 'default', i) {
            ...
            return g.$shared && ((g.$shared = l), (r[o] = Object.freeze(ca(g, l)))), g;
        }
        ...
        updateElement(t, e, i, n) {
            sr(n) ? Object.assign(t, i) : this._resolveAnimations(e, n).update(t, i);
        }
...
function Xh(s, t, e, i) {
    let n = e.barThickness,
        ...
        o;
    return (
        R(n) ? ((r = t.min * e.categoryPercentage), (o = e.barPercentage)) : ((r = n * i), (o = 1)),
...
function Kh(s, t, e, i) {
    ...
    return { chunk: ((Math.abs(a - o) / 2) * l) / i, ratio: e.barPercentage, start: c };
}
function Jh(s, t, e, i) {
    let n = e.parse(s[0], i),
        r = e.parse(s[1], i),
...
function ha(s, t, e, i) {
    let n = s.iScale,
        ...
        d;
    for (c = e, h = e + i; c < h; ++c)
        (d = t[c]), (u = {}), (u[n.axis] = a || n.parse(o[c], c)), l.push(Ga(d, u, r, c));
    return l;
}
function ir(s) {
...
var $e = class extends pt {
    ...
    parseObjectData(t, e, i, n) {
        let { iScale: r, vScale: o } = t,
            ...
            g;
        for (d = i, f = i + n; d < f; ++d)
            (g = e[d]), (m = {}), (m[r.axis] = r.parse(Bt(g, c), d)), u.push(Ga(Bt(g, h), m, o, d));
        return u;
    }
    updateRangeFromParsed(t, e, i, n) {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            ...
            r = this.getParsed(t),
            o = r._custom,
            a = ir(o) ? '[' + o.start + ', ' + o.end + ']' : '' + n.getLabelForValue(r[n.axis]);
    ...
    updateElements(t, e, i, n) {
        ...
        for (let f = e; f < e + i; f++) {
            let m = this.getParsed(f),
                g = r || R(m[a.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
                p = this._calculateBarIndexPixels(f, h),
                y = (m._stacks || {})[a.axis],
                b = {
                    horizontal: c,
                    base: g.base,
                    enableBorderRadius: !y || ir(m._custom) || o === y._top || o === y._bottom,
                    x: c ? g.head : p.center,
                    y: c ? p.center : g.head,
            ...
            eu(b, _, y, o), iu(b, _, h.ratio), this.updateElement(t[f], f, b, n);
        }
    }
    _getStacks(t, e) {
        ...
        for (let l of n)
            if (
                !(e !== void 0 && a(l)) &&
                ((r === !1 || o.indexOf(l.stack) === -1 || (r === void 0 && l.stack === void 0)) &&
                    o.push(l.stack),
                l.index === t)
            )
                break;
    ...
    draw() {
        let t = this._cachedMeta,
            ...
            n = i.length,
            r = 0;
        for (; r < n; ++r) this.getParsed(r)[e.axis] !== null && i[r].draw(this._ctx);
    }
};
$e.id = 'bar';
$e.defaults = {
...
var je = class extends pt {
    ...
    parseArrayData(t, e, i, n) {
        ...
        for (let o = 0; o < r.length; o++) {
            let a = e[i + o];
            r[o]._custom = I(a[2], this.resolveDataElementOptions(o + i).radius);
        }
        return r;
    }
    parseObjectData(t, e, i, n) {
        ...
        for (let o = 0; o < r.length; o++) {
            let a = e[i + o];
            r[o]._custom = I(a && a.r && +a.r, this.resolveDataElementOptions(o + i).radius);
        }
        return r;
    }
    getMaxOverflow() {
    ...
    resolveDataElementOptions(t, e) {
        ...
        let r = n.radius;
        return e !== 'active' && (n.radius = 0), (n.radius += I(i && i._custom, r)), n;
    }
};
je.id = 'bubble';
je.defaults = {
...
function nu(s, t, e) {
    ...
    if (t < B) {
        let a = s,
            ...
            y = m(Y, c, u),
            b = m(Y + Z, h, d);
        (i = (g - y) / 2), (n = (p - b) / 2), (r = -(g + y) / 2), (o = -(p + b) / 2);
    }
...
oe.descriptors = { _scriptable: (s) => s !== 'spacing', _indexable: (s) => s !== 'spacing' };
oe.overrides = {
    aspectRatio: 1,
    plugins: {
        legend: {
...
Ue.id = 'line';
Ue.defaults = { datasetElementType: 'line', dataElementType: 'point', showLine: !0, spanGaps: !1 };
Ue.overrides = { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } };
...
var Xa = {
    ...
    logarithmic(s, t, e) {
        ...
        return i === 1 || i === 2 || i === 5 ? Xa.numeric.call(this, s, t, e) : '';
    },
};
function ru(s, t) {
...
function hu(s, t, e, i) {
    let n = 0,
        r = e[0],
        o;
    for (i = Math.ceil(i), o = 0; o < s.length; o++) o === r && (t.push(s[o]), n++, (r = e[n * i]));
}
function Li(s, t, e, i, n) {
    let r = I(i, 0),
        ...
        c,
        h;
    for (e = Math.ceil(e), n && ((l = n - i), (e = l / Math.floor(l / e))), h = r; h < 0; )
...
function bu(s, t, e, i) {
    ...
    if (s.isHorizontal()) {
        ...
        } else e === 'center' ? (m = (c.bottom + c.top) / 2 + g - t) : (m = fa(s, e, t));
        d = a - r;
    } else {
        if (A(e)) {
            let y = Object.keys(e)[0],
        ...
        } else e === 'center' ? (f = (c.left + c.right) / 2 - p + t) : (f = fa(s, e, t));
...
var Yt = class extends yt {
        ...
        getUserBounds() {
            ...
            return (
                ...
                { min: mt(t, i), max: mt(e, n), minDefined: K(t), maxDefined: K(e) }
            );
        }
        getMinMax(t) {
            let { min: e, max: i, minDefined: n, maxDefined: r } = this.getUserBounds(),
                o;
        ...
        calculateLabelRotation() {
            let t = this.options,
                ...
                l,
                c;
            if (!this._isVisible() || !e.display || n >= r || i <= 1 || !this.isHorizontal()) {
                ...
                u + 6 > a &&
                    ...
                    (o = Ti(
                        Math.min(
                            ...
                            Math.asin(it(l / c, -1, 1)) - Math.asin(it(d / c, -1, 1)),
                        ),
                    )),
            ...
            for (c = 0; c < e; ++c) {
                if (
                    ...
                    for (h = 0, u = d.length; h < u; ++h)
                        (_ = d[h]), !R(_) && !$(_) && ((y = bs(i, g.data, g.gc, y, _)), (b += p));
        ...
        getContext(t) {
            ...
            return this.$context || (this.$context = gu(this.chart.getContext(), this));
        }
        _tickSize() {
        ...
        drawTitle() {
            ...
            e === 'bottom' || e === 'center' || A(e)
                ? ((l += o.bottom), $(i.text) && (l += r.lineHeight * (i.text.length - 1)))
                : (l += o.top);
            let { titleX: c, titleY: h, maxWidth: u, rotation: d } = bu(this, l, e, a);
            ee(t, i.text, 0, 0, r, {
                color: i.color,
                maxWidth: u,
                rotation: d,
    ...
    Be = class {
        ...
        register(t) {
            ...
            return (
                r in n || ((n[r] = t), xu(t, o, i), this.override && L.override(t.id, t.overrides)),
                o
            );
        }
        get(t) {
...
var dr = class {
    ...
    qe = class extends pt {
        ...
        addElements() {
            ...
            !this.datasetElementType && t && (this.datasetElementType = Pt.getElement('line')),
                super.addElements();
        }
        updateElements(t, e, i, n) {
            let r = n === 'reset',
            ...
            for (let w = e; w < e + i; ++w) {
                let x = t[w],
                    ...
                    F = (k[m] =
                        r || O
                            ? a.getBasePixel()
                            : a.getPixelForValue(l ? this.applyStack(a, S, l) : S[m], w));
...
qe.id = 'scatter';
qe.defaults = { datasetElementType: !1, dataElementType: 'point', showLine: !1, fill: !1 };
qe.overrides = {
...
function Tu(s, t, e, i) {
    let n = [];
    function r(o, a, l) {
        let { startAngle: c, endAngle: h } = o.getProps(['startAngle', 'endAngle'], i),
...
function rr(s, t, e, i, n, r) {
    return !r && !s.isPointInArea(t) ? [] : e === 'r' && !i ? Tu(s, t, e, n) : vu(s, t, e, i, n, r);
}
...
function Ds(s, t, e, i) {
    ...
    for (r = 0, o = s.length, c = 0; r < o; ++r) {
        (a = s[r]), (l = a.box), l.update(a.width || t.w, a.height || t.h, Lu(a.horizontal, t));
...
L.set('layout', { autoPadding: !0, padding: { top: 0, right: 0, bottom: 0, left: 0 } });
var lt = {
        addBox(s, t) {
            s.boxes || (s.boxes = []),
...
function zu(s, t) {
    let e = Pu[s.type] || s.type,
        { x: i, y: n } = ie(s, t);
    return { type: e, chart: t, native: s, x: i !== void 0 ? i : null, y: n !== void 0 ? n : null };
}
function $i(s, t) {
...
function Vu(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((r) => {
            let o = !1;
            for (let a of r) (o = o || $i(a.addedNodes, i)), (o = o && !$i(a.removedNodes, i));
            o && e();
        });
...
function Hu(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((r) => {
            let o = !1;
            for (let a of r) (o = o || $i(a.removedNodes, i)), (o = o && !$i(a.addedNodes, i));
            o && e();
        });
    return n.observe(document, { childList: !0, subtree: !0 }), n;
}
...
var mr = class extends Bi {
    ...
    removeEventListener(t, e) {
        let i = t.$proxies || (t.$proxies = {}),
            n = i[e];
        if (!n) return;
        (({ attach: or, detach: or, resize: or })[e] || Wu)(t, e, n), (i[e] = void 0);
    }
    getDevicePixelRatio() {
...
function Yu(s) {
    return !qn() || (typeof OffscreenCanvas < 'u' && s instanceof OffscreenCanvas) ? fr : mr;
}
var gr = class {
    constructor() {
        this._init = [];
...
function Gu(s, { plugins: t, localIds: e }, i, n) {
    ...
    for (let a of t) {
        let l = a.id,
            c = qu(i[l], n);
        c !== null &&
            r.push({ plugin: a, options: Xu(s.config, { plugin: a, local: e[l] }, c, o) });
    }
    return r;
}
function Xu(s, { plugin: t, local: e }, i, n) {
    ...
    return (
        ...
        s.createResolver(o, n, [''], { scriptable: !1, indexable: !1, allKeys: !0 })
    );
}
function pr(s, t) {
    let e = L.datasets[s] || {};
...
function yr(s, t) {
    return s === 'x' || s === 'y' ? s : t.axis || Qu(t.position) || s.charAt(0).toLowerCase();
}
function td(s, t) {
    ...
    return (
        Object.keys(i).forEach((a) => {
            ...
            let c = yr(a, l),
                h = Ju(c, n),
                u = e.scales || {};
            (r[c] = r[c] || a), (o[a] = Pe(Object.create(null), [{ axis: c }, l, u[c], u[h]]));
        }),
        s.data.datasets.forEach((a) => {
            ...
            Object.keys(u).forEach((d) => {
                let f = Ku(d, c),
                    m = a[f + 'AxisID'] || r[f] || f;
                (o[m] = o[m] || Object.create(null)), Pe(o[m], [{ axis: f }, i[m], u[d]]);
            });
        }),
...
var Os = (s, t, e) => {
    ...
    br = class {
        ...
        getOptionScopes(t, e, i) {
            ...
            let c = Array.from(l);
            return c.length === 0 && c.push(Object.create(null)), il.has(e) && o.set(e, c), c;
        }
        chartOptionScopes() {
...
var sd = (s) => A(s) && Object.getOwnPropertyNames(s).reduce((t, e) => t || Ht(s[e]), !1);
function id(s, t) {
...
var xe = class {
        constructor(t, e) {
            ...
            (this.platform = new (i.platform || Yu(n))()), this.platform.updateConfig(i);
            ...
            if (
                ...
                (this.$context = void 0),
                (this._doResize = Po((u) => this.update(u), o.resizeDelay || 0)),
                (this._dataChanges = []),
                (ji[this.id] = this),
                !a || !l)
            ) {
        ...
        _initialize() {
            return (
                ...
                this.options.responsive ? this.resize() : Gn(this, this.options.devicePixelRatio),
                this.bindEvents(),
            ...
            e &&
                ...
                H(r, (o) => {
                    let a = o.options,
                        ...
                        c = yr(l, a),
                        h = I(a.type, o.dtype);
                    (a.position === void 0 || Ma(a.position, c) !== Ma(o.dposition)) &&
                    ...
                    if (l in i && i[l].type === h) u = i[l];
                        ...
                        let d = Pt.getScale(h);
                        (u = new d({ id: l, type: h, ctx: this.ctx, chart: this })), (i[u.id] = u);
                    }
                    u.init(a, t);
                }),
                H(n, (o, a) => {
        ...
        _removeUnreferencedMetasets() {
            ...
            t.length > e.length && delete this._stacks,
                t.forEach((i, n) => {
                    e.filter((r) => r === i._dataset).length === 0 && this._destroyDatasetMeta(n);
                });
        }
        ...
        _getUniformDataChanges() {
            ...
            let e = this.data.datasets.length,
                i = (r) =>
                    new Set(
                        t.filter((o) => o[0] === r).map((o, a) => a + ',' + o.splice(1).join(',')),
                    ),
                n = i(0);
        ...
        getContext() {
            return this.$context || (this.$context = $t(null, { chart: this, type: 'chart' }));
        }
        ...
        _eventHandler(t, e) {
            let i = { event: t, replay: e, cancelable: !0, inChartArea: this.isPointInArea(t) },
...
function ol(s, t, e) {
    let { startAngle: i, pixelMargin: n, x: r, y: o, outerRadius: a, innerRadius: l } = t,
        c = n / a;
    s.beginPath(),
        s.arc(r, o, a, i - c, e + c),
        l > n ? ((c = n / l), s.arc(r, o, l, e + c, i - c, !0)) : s.arc(r, o, n, e + Z, i - Z),
        s.closePath(),
        s.clip();
}
function cd(s) {
...
function xr(s, t, e, i, n, r) {
    ...
    let g = Math.max(0.001, m * u - e / Y) / u,
        ...
        y = l + p + f,
        b = n - p - f,
        { outerStart: _, outerEnd: w, innerStart: x, innerEnd: S } = hd(t, d, u, b - y),
        k = u - _,
        O = u - w,
        T = y + _ / k,
        F = b - w / O,
...
function dd(s, t, e) {
    let { x: i, y: n, startAngle: r, pixelMargin: o, fullCircles: a } = t,
        ...
        c = t.innerRadius + o,
        h;
    for (e && ol(s, t, r + B), s.beginPath(), s.arc(i, n, c, r + B, r, !0), h = 0; h < a; ++h)
        s.stroke();
...
function gd(s) {
    return s.stepped ? $o : s.tension || s.cubicInterpolationMode === 'monotone' ? jo : md;
}
function ll(s, t, e = {}) {
    let i = s.length,
...
function pd(s, t, e, i) {
    ...
    for (f = 0; f <= c; ++f)
        (m = n[(a + (d ? c - f : f)) % o]),
            !m.skip && (u ? (s.moveTo(m.x, m.y), (u = !1)) : h(s, g, m, d, r.stepped), (g = m));
...
function bd(s) {
    return s.stepped ? Qo : s.tension || s.cubicInterpolationMode === 'monotone' ? ta : Xt;
}
function xd(s, t, e, i) {
    let n = t._path;
...
var Nt = class extends yt {
    ...
    draw(t, e, i, n) {
        let r = this.options || {};
        (this.points || []).length && r.borderWidth && (t.save(), Sd(t, this, i, n), t.restore()),
...
Nt.descriptors = { _scriptable: !0, _indexable: (s) => s !== 'borderDash' && s !== 'fill' };
function Da(s, t, e, i) {
    let n = s.options,
        { [e]: r } = s.getProps([e], i);
...
function cl(s, t) {
    ...
    return (
        s.horizontal
            ? ((u = o / 2), (a = Math.min(e, n)), (l = Math.max(e, n)), (c = i - u), (h = i + u))
            : ((u = r / 2), (a = e - u), (l = e + u), (c = Math.min(i, n)), (h = Math.max(i, n))),
...
Ke.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' };
...
function Ed(s, t, e, i, n) {
    ...
    for (o[l++] = s[h], u = 0; u < r - 2; u++) {
        ...
        let S = Math.floor(u * a) + 1 + t,
            ...
            { x: O, y: T } = s[h];
        for (f = m = -1, b = S; b < k; b++)
            (m = 0.5 * Math.abs((O - p) * (s[b].y - T) - (O - s[b].x) * (y - T))),
                m > f && ((f = m), (d = s[b]), (g = b));
        (o[l++] = d), (h = g);
    }
    return (o[l++] = s[c]), o;
...
function Id(s, t, e, i) {
    ...
    for (o = t; o < t + e; ++o) {
        ...
        let x = l | 0;
        if (x === h)
            c < m ? ((m = c), (u = o)) : c > g && ((g = c), (d = o)), (n = (r * n + a.x) / ++r);
        else {
            let S = o - 1;
            if (!R(u) && !R(d)) {
                let k = Math.min(u, d),
...
function wr(s, t, e, i) {
    ...
    let n = t[s],
        r = e[s];
    return s === 'angle' && ((n = ht(n)), (r = ht(r))), { property: s, start: n, end: r };
}
function Ld(s, t) {
...
function ul(s, t) {
    ...
    return (
        $(s) ? ((i = !0), (e = s)) : (e = Ld(s, t)),
        e.length ? new Nt({ points: e, options: { tension: 0 }, _loop: i, _fullLoop: i }) : null
    );
}
function Ca(s) {
    return s && s.fill !== !1;
...
var Ui = class {
    ...
    pathSegment(t, e, i) {
        ...
        return (e = e || { start: 0, end: B }), t.arc(n, r, o, e.end, e.start, !0), !i.bounds;
    }
    interpolate(t) {
...
function Gd(s) {
    ...
    if (i.grid.circular) {
        ...
        return new Ui({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(o) });
    }
...
function cr(s, t, e) {
    ...
    i &&
        n.points.length &&
        (ws(s, e),
        Xd(s, { line: n, target: i, above: h, below: u, area: e, scale: r, axis: o }),
        Ss(s));
}
function Xd(s, t) {
...
function Fa(s, t, e) {
    ...
    for (let a of i) {
        let { start: l, end: c } = a,
            h = n[l],
            u = n[Mr(l, c, n)];
        r ? (s.moveTo(h.x, h.y), (r = !1)) : (s.lineTo(h.x, e), s.lineTo(h.x, h.y)),
...
var Jd = {
        ...
        afterDatasetsUpdate(s, t, e) {
            ...
            for (o = 0; o < i; ++o)
                (r = s.getDatasetMeta(o)),
                    ...
                    n.push(l);
            for (o = 0; o < i; ++o)
                (l = n[o]), !(!l || l.fill === !1) && (l.fill = Pd(n, o, e.propagate));
        },
        beforeDraw(s, t, e) {
            ...
            for (let o = n.length - 1; o >= 0; --o) {
                let a = n[o].$filler;
                a && (a.line.updateControlPoints(r, a.axis), i && a.fill && cr(s.ctx, a, r));
            }
        },
        ...
        beforeDatasetDraw(s, t, e) {
            let i = t.meta.$filler;
            !Ca(i) || e.drawTime !== 'beforeDatasetDraw' || cr(s.ctx, i, s.chartArea);
        },
    ...
    Yi = class extends yt {
        ...
        adjustHitBoxes() {
            ...
            if (this.isHorizontal()) {
                ...
                for (let c of e)
                    a !== c.row &&
                        ((a = c.row), (l = ot(i, this.left + n, this.right - this.lineWidths[a]))),
                        (c.top += this.top + t + n),
                        (c.left = o.leftForLtr(o.x(l), c.width)),
                        (l += c.width + n);
            } else {
                let a = 0,
                    l = ot(i, this.top + t + n, this.bottom - this.columnSizes[a].height);
                for (let c of e)
                    c.col !== a &&
                        ((a = c.col),
                        (l = ot(i, this.top + t + n, this.bottom - this.columnSizes[a].height))),
        ...
        _draw() {
            ...
            w
                ? (m = { x: ot(r, this.left + u, this.right - i[0]), y: this.top + u + x, line: 0 })
                : (m = {
                      x: this.left + u,
                ...
                l.setWidth(this.width),
                    w
                        ? O > 0 &&
                          ...
                          ((Q = m.y += S),
                          m.line++,
                          (P = m.x = ot(r, this.left + u, this.right - i[m.line])))
                        : O > 0 &&
                          Q + S > this.bottom &&
                          ((P = m.x = P + e[m.line].width + u),
                          m.line++,
                          (Q = m.y = ot(r, this.top + x + u, this.bottom - e[m.line].height)));
                let ct = l.x(P);
                b(ct, Q, k),
...
var ef = {
            ...
            labels: {
                ...
                generateLabels(s) {
                    let t = s.data.datasets,
                        {
                            labels: { usePointStyle: e, pointStyle: i, textAlign: n, color: r },
                        } = s.legend.options;
        ...
        descriptors: {
            _scriptable: (s) => !s.startsWith('on'),
            labels: { _scriptable: (s) => !['generateLabels', 'filter', 'sort'].includes(s) },
        },
    },
    As = class extends yt {
        constructor(t) {
...
function Na(s, t) {
    let e = s.chart.ctx,
        ...
        g = m.height,
        p = 0,
        y = i.reduce((w, x) => w + x.before.length + x.lines.length + x.after.length, 0);
    if (
...
function lf(s, t, e, i) {
    ...
    if ((s === 'left' && n + r + o > t.width) || (s === 'right' && n - r - o < 0)) return !0;
}
function cf(s, t, e, i) {
    let { x: n, width: r } = e,
        {
...
var Ls = class extends yt {
    ...
    getContext() {
        return (
            this.$context || (this.$context = df(this.chart.getContext(), this, this._tooltipItems))
        );
    }
    getTitle(t, e) {
        let { callbacks: i } = e,
    ...
    _updateAnimationTarget(t) {
        let e = this.chart,
            ...
            r = i && i.y;
        if (n || r) {
            let o = Es[t.position].call(this, this._active, this._eventPosition);
            if (!o) return;
...
var yf = (s, t) => (s === null ? null : it(Math.round(s), 0, t)),
    Je = class extends Yt {
        ...
        parse(t, e) {
            ...
            let i = this.getLabels();
            return (
                (e = isFinite(e) && i[e] === t ? e : pf(i, t, I(e, t), this._addedLabels)),
                yf(e, i.length - 1)
            );
        }
        determineDataLimits() {
...
function bf(s, t) {
    ...
    (T = Math.ceil(p / x) - Math.floor(g / x)),
        ...
        y && b && r && Eo((a - o) / r, x / 1e3)
            ? ((T = Math.round(Math.min((a - o) / x, h))), (x = (a - o) / T), (k = o), (O = a))
            : _
              ? ((k = y ? o : k), (O = b ? a : O), (T = c - 1), (x = (O - k) / T))
              : ((T = (O - k) / x),
                Ne(T, Math.round(T), x / 1e3) ? (T = Math.round(T)) : (T = Math.ceil(T)));
    let F = Math.max(En(x), En(k));
    (S = Math.pow(10, R(l) ? F : l)), (k = Math.round(k * S) / S), (O = Math.round(O * S) / S);
    let W = 0;
    for (
        y &&
        (d && k !== o
...
var Qe = class extends Yt {
        ...
        parse(t, e) {
            return R(t) || ((typeof t == 'number' || t instanceof Number) && !isFinite(+t))
                ? null
                : +t;
        }
...
var Ns = class extends Yt {
    ...
    handleTickRangeOptions() {
        ...
        i === n && (i <= 0 ? (r(1), o(10)) : (r(a(i, -1)), o(a(n, 1)))),
            i <= 0 && r(a(n, -1)),
            n <= 0 && o(a(i, 1)),
            this._zero && this.min !== this._suggestedMin && i === a(this.min, 0) && r(a(i, -1)),
            (this.min = i),
            (this.max = n);
    }
    buildTicks() {
...
Ns.id = 'logarithmic';
Ns.defaults = { ticks: { callback: Zi.formatters.logarithmic, major: { enabled: !0 } } };
function Sr(s) {
    let t = s.ticks;
...
function _f(s, t, e) {
    return (e = $(e) ? e : [e]), { w: Bo(s, t.string, e), h: e.length * t.lineHeight };
}
...
function Sf(s, t, e, i, n) {
    ...
    i.start < t.l
        ...
        : i.end > t.r && ((a = (i.end - t.r) / r), (s.r = Math.max(s.r, t.r + a))),
        n.start < t.t
            ? ((l = (t.t - n.start) / o), (s.t = Math.min(s.t, t.t - l)))
            : n.end > t.b && ((l = (n.end - t.b) / o), (s.b = Math.max(s.b, t.b + l)));
}
function kf(s, t, e) {
    let i = [],
    ...
    for (let c = 0; c < n; c++) {
        let h = s.getPointPosition(c, a + o + e[c], l),
            ...
            m = Mf(u),
            g = Tf(h.x, d.w, m);
        i.push({ x: h.x, y: f, textAlign: m, left: g, top: f, right: g + d.w, bottom: f + d.h });
    }
    return i;
}
function Mf(s) {
    ...
    for (let n = t - 1; n >= 0; n--) {
        ...
        if (!R(m)) {
            ...
            Object.values(g).some((x) => x !== 0)
                ? (e.beginPath(), We(e, { x: y, y: b, w: _, h: w, radius: g }), e.fill())
                : e.fillRect(y, b, _, w);
        }
...
function dl(s, t, e, i) {
    ...
    if (e) n.arc(s.xCenter, s.yCenter, t, 0, B);
        ...
        n.moveTo(r.x, r.y);
        for (let o = 1; o < i; o++) (r = s.getPointPosition(o, t)), n.lineTo(r.x, r.y);
    }
}
function Df(s, t, e, i) {
    let n = s.ctx,
...
var _e = class extends Qe {
    ...
    fit() {
        let t = this.options;
        t.display && t.pointLabels.display ? wf(this) : this.setCenterPoint(0, 0, 0, 0);
    }
...
function Ff(s) {
    for (let t = ut.indexOf(s) + 1, e = ut.length; t < e; ++t) if (qi[ut[t]].common) return ut[t];
}
function Ya(s, t, e) {
    if (!e) s[t] = !0;
    else if (e.length) {
...
function Af(s, t, e, i) {
    let n = s._adapter,
        ...
        a,
        l;
    for (a = r; a <= o; a = +n.add(a, 1, i)) (l = e[a]), l >= 0 && (t[l].major = !0);
    return t;
}
function Za(s, t, e) {
    let i = [],
        ...
        o,
        a;
    for (o = 0; o < r; ++o) (a = t[o]), (n[a] = o), i.push({ value: a, major: !1 });
...
var we = class extends Yt {
    ...
    buildTicks() {
        ...
        return (
            (this._unit =
                e.unit ||
                (i.autoSkip
                    ? Ua(e.minUnit, this.min, this.max, this._getLabelCapacity(r))
                    : Cf(this, a.length, e.minUnit, this.min, this.max))),
            (this._majorUnit = !i.major.enabled || this._unit === 'year' ? void 0 : Ff(this._unit)),
            this.initOffsets(n),
            t.reverse && a.reverse(),
    ...
    _getLabelCapacity(t) {
        let e = this.options.time,
            ...
            r = this._tickFormatFunction(t, 0, Za(this, [t], this._majorUnit), n),
...
function zi(s, t, e) {
    let i = 0,
        ...
        l;
    e
        ? (t >= s[i].pos && t <= s[n].pos && ({ lo: i, hi: n } = Ct(s, 'pos', t)),
          ({ pos: r, time: a } = s[i]),
          ({ pos: o, time: l } = s[n]))
        : (t >= s[i].time && t <= s[n].time && ({ lo: i, hi: n } = Ct(s, 'time', t)),
          ({ time: r, pos: a } = s[i]),
          ({ time: o, pos: l } = s[n]));
    let c = o - r;
...
var Rs = class extends we {
    ...
    buildLookupTable(t) {
        let { min: e, max: i } = this,
            ...
            c,
            h;
        for (o = 0, a = t.length; o < a; ++o) (c = t[o]), c >= e && c <= i && n.push(c);
        if (n.length < 2)
            return [
                { time: e, pos: 0 },
                { time: i, pos: 1 },
...
var M = 'numeric',
    ...
    ei = { year: M, month: bt, day: M, hour: M, minute: M, second: M, timeZoneName: Dt },
    si = { year: M, month: bt, day: M, weekday: bt, hour: M, minute: M, timeZoneName: bt },
    ii = {
        year: M,
        month: bt,
        day: M,
...
var Fr = class {
        constructor(t, e, i) {
            ...
            if (!e || Object.keys(o).length > 0) {
                ...
                i.padTo > 0 && (a.minimumIntegerDigits = i.padTo), (this.inf = Vf(t, a));
            }
        }
        format(t) {
            if (this.inf) {
    ...
    Lr = class {
        constructor(t, e, i) {
            (this.opts = { style: 'long', ...i }), !e && nn() && (this.rtf = Hf(t, i));
        }
        format(t, e) {
            return this.rtf
                ? this.rtf.format(t, e)
    ...
    N = class {
        ...
        constructor(t, e, i, n, r) {
            ...
            (this.locale = o),
                ...
                (this.weekSettings = n),
                (this.intl = Uf(this.locale, this.numberingSystem, this.outputCalendar)),
        ...
        get fastNumbers() {
            return (
                this.fastNumbersCached == null && (this.fastNumbersCached = qf(this)),
            ...
            return sn(this, t, Pr, () => {
                ...
                return (
                    this.monthsCache[n][t] ||
                        (this.monthsCache[n][t] = Yf((r) => this.extract(r, i, 'month'))),
                    this.monthsCache[n][t]
                );
            });
        }
            ...
            return sn(this, t, Nr, () => {
                ...
                return (
                    this.weekdaysCache[n][t] ||
                        (this.weekdaysCache[n][t] = Zf((r) => this.extract(r, i, 'weekday'))),
                    this.weekdaysCache[n][t]
                );
            });
        }
        ...
        eras(t) {
            return sn(this, t, Wr, () => {
                ...
                return (
                    this.eraCache[t] ||
                        (this.eraCache[t] = [v.utc(-40, 1, 1), v.utc(2017, 1, 1)].map((i) =>
        ...
        getWeekSettings() {
            return this.weekSettings ? this.weekSettings : rn() ? $f(this.locale) : Gf;
        }
        getStartOfWeek() {
...
function Hr(s, t = 4, e = 1) {
    let { weekYear: i, weekNumber: n, weekday: r } = s,
        ...
        l = n * 7 + r - o - 7 + t,
        c;
    l < 1 ? ((c = i - 1), (l += ce(c))) : l > a ? ((c = i + 1), (l -= ce(i))) : (c = i);
...
function $r(s, t) {
    if (!D(s.localWeekday) || !D(s.localWeekNumber) || !D(s.localWeekYear)) {
        if (!D(s.weekday) || !D(s.weekNumber) || !D(s.weekYear))
            throw new vt('Cannot mix locale-based week fields with ISO-based week fields');
        return (
...
function jr(s) {
    ...
    return t ? (e ? (i ? !1 : St('day', s.day)) : St('month', s.month)) : St('year', s.year);
}
function Ur(s) {
...
function ri(s) {
    ...
    return { firstDay: s.firstDay, minimalDays: s.minimalDays, weekend: Array.from(s.weekend) };
}
function xt(s, t, e) {
    return ai(s) && s >= t && s <= e;
}
...
function ns(s, t) {
    let e = Xf(t - 1, 12) + 1,
        i = s + (t - e) / 12;
    return e === 2 ? (Me(i) ? 29 : 28) : [31, null, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e - 1];
}
function es(s) {
...
var Gr = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
    ...
    X = class {
        ...
        static parseFormat(t) {
            ...
            for (let o = 0; o < t.length; o++) {
                let a = t.charAt(o);
                a === "'"
                    ? (i.length > 0 && r.push({ literal: n || /^\s+$/.test(i), val: i }),
                      (e = null),
                      (i = ''),
                      (n = !n))
                    : n || a === e
                      ? (i += a)
                      : (i.length > 0 && r.push({ literal: /^\s+$/.test(i), val: i }),
                        (i = a),
                        (e = a));
            }
            return i.length > 0 && r.push({ literal: n || /^\s+$/.test(i), val: i }), r;
        }
                ...
                o = (f) =>
                    t.isOffsetFixed && t.offset === 0 && f.allowZ
                        ...
                        : t.isValid
                          ...
                          : '',
                a = () => (i ? Nl(t) : r({ hour: 'numeric', hourCycle: 'h12' }, 'dayperiod')),
                l = (f, m) =>
                    i ? Wl(t, f) : r(m ? { month: f } : { month: f, day: 'numeric' }, 'month'),
                c = (f, m) =>
                    i
                        ? Rl(t, f)
                        : r(
...
var Bl = /[A-Za-z_+-]{1,256}(?::?\/[A-Za-z0-9_+-]{1,256}(?:\/[A-Za-z0-9_+-]{1,256})?)?/;
function as(...s) {
...
function dm(s, t) {
    return [{ year: os(s, t), month: os(s, t + 1, 1), day: os(s, t + 2, 1) }, null, t + 3];
}
function hs(s, t) {
    return [
        {
...
var C = class {
    ...
    static fromISO(t, e) {
        ...
        return i
            ? C.fromObject(i, e)
            : C.invalid('unparsable', `the input "${t}" can't be parsed as ISO 8601`);
    }
    ...
    static invalid(t, e = null) {
        if (!t) throw new st('need to specify a reason the Duration is invalid');
    ...
    toFormat(t, e = {}) {
        ...
        return this.isValid ? X.create(this.loc, i).formatDurationFromString(this, t) : tc;
    }
    toHuman(t = {}) {
    ...
    plus(t) {
        ...
        let e = C.fromDurationLike(t),
            i = {};
        for (let n of Te)
            (he(e.values, n) || he(this.values, n)) && (i[n] = e.get(n) + this.get(n));
    ...
    shiftTo(...t) {
        ...
        for (let o in i) i[o] !== 0 && (e[r] += o === r ? i[o] : i[o] / this.matrix[r][o]);
...
var U = class {
    ...
    static invalid(t, e = null) {
        if (!t) throw new st('need to specify a reason the Interval is invalid');
        let i = t instanceof rt ? t : new rt(t, e);
    ...
    count(t = 'milliseconds', e) {
        ...
        let i = this.start.startOf(t, e),
            n;
        return (
            e?.useLocaleWeeks ? (n = this.end.reconfigure({ locale: i.locale })) : (n = this.end),
            (n = n.startOf(t, e)),
            Math.floor(n.diff(i, t).get(t)) + (n.valueOf() !== this.end.valueOf())
        );
    }
    hasSame(t) {
    ...
    splitBy(t) {
        ...
        for (; i < this.e; ) {
            ...
            (r = +a > +this.e ? this.e : a), o.push(U.fromDateTimes(i, r)), (i = r), (n += 1);
        }
        return o;
    }
    divideEqually(t) {
    ...
    toDuration(t, e) {
        return this.isValid ? this.e.diff(this.s, t, e) : C.invalid(this.invalidReason);
    }
    mapEndpoints(t) {
...
function Vm(s, t, e) {
    ...
    for (let [l, c] of i)
        e.indexOf(l) >= 0 &&
            ...
            (a = r.plus(n)),
            a > t
                ? (n[l]--, (s = r.plus(n)), s > t && ((a = s), n[l]--, (s = r.plus(n))))
                : (s = a));
    return [s, n, a, o];
}
function rc(s, t, e, i) {
    ...
    c.length === 0 &&
        (o < t && (o = n.plus({ [a]: 1 })), o !== n && (r[a] = (r[a] || 0) + l / (o - n)));
...
function Ym(s, t) {
    let e = Mt(t),
        ...
        u = Mt(t, '{2,4}'),
        d = Mt(t, '{4,6}'),
        f = (p) => ({ regex: RegExp(Um(p.val)), deser: ([y]) => y, literal: !0 }),
        g = ((p) => {
    ...
    if (i) {
        ...
        for (let o in e)
            if (he(e, o)) {
                ...
                !a.literal && a.token && (n[a.token.val[0]] = a.deser(i.slice(r, r + l))), (r += l);
            }
        return [i, n];
    } else return [i, {}];
}
function Km(s) {
    ...
    return (
        ...
        D(s.q) || (s.M = (s.q - 1) * 3 + 1),
        D(s.h) || (s.h < 12 && s.a === 1 ? (s.h += 12) : s.h === 12 && s.a === 0 && (s.h = 0)),
        s.G === 0 && s.y && (s.y = -s.y),
        D(s.u) || (s.S = ci(s.u)),
        [
...
function io(s, t, e) {
    ...
    if (r) return { input: t, tokens: i, invalidReason: r.invalidReason };
    {
        ...
        if (he(h, 'a') && he(h, 'H'))
            throw new vt("Can't include meridiem when specifying 24-hour format");
        return {
            input: t,
            tokens: i,
            regex: l,
...
function dc(s, t, e) {
    let { result: i, zone: n, specificOffset: r, invalidReason: o } = io(s, t, e);
    return [i, n, r, o];
}
function no(s, t) {
    if (!s) return null;
...
function ao(s) {
    return (
        s.localWeekData === null &&
            (s.localWeekData = oi(s.c, s.loc.getMinDaysInFirstWeek(), s.loc.getStartOfWeek())),
        s.localWeekData
    );
}
function ve(s, t) {
    let e = { ts: s.ts, zone: s.zone, c: s.c, o: s.o, loc: s.loc, invalid: s.invalid };
...
function mc(s, t) {
    let e = s.o,
        ...
        r = {
            ...
            year: i,
            month: n,
            day: Math.min(s.c.day, ns(i, n)) + Math.trunc(t.days) + Math.trunc(t.weeks) * 7,
        },
        o = C.fromObject({
...
function fi(s, t, e, i, n, r) {
    ...
    } else return v.invalid(new rt('unparsable', `the input "${n}" can't be parsed as ${i}`));
}
function dn(s, t, e = !0) {
    return s.isValid
        ? X.create(N.create('en-US'), { allowZ: e, forceSimple: !0 }).formatDateTimeFromString(s, t)
        : null;
}
function lo(s, t) {
...
function gc(s, t, e, i, n, r) {
    ...
    return (
        ...
        (s.c.millisecond !== 0 || s.c.second !== 0 || !e) &&
            ((o += q(s.c.second)),
            (s.c.millisecond !== 0 || !i) && ((o += '.'), (o += q(s.c.millisecond, 3)))),
        n &&
...
var wc = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
    tg = { weekNumber: 1, weekday: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
...
function bc(s, t, e) {
    let i = D(e.round) ? !0 : e.round,
        n = (o, a) => (
            (o = ss(o, i || e.calendary ? 0 : 2, !0)), t.loc.clone(e).relFormatter(e).format(o, a)
        ),
        r = (o) =>
            e.calendary
                ? t.hasSame(s, o)
...
var v = class {
    ...
    static local() {
        let [t, e] = xc(arguments),
            [i, n, r, o, a, l, c] = e;
        return yc({ year: i, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t);
    }
    static utc() {
        let [t, e] = xc(arguments),
            [i, n, r, o, a, l, c] = e;
        return (
            ...
            yc({ year: i, month: n, day: r, hour: o, minute: a, second: l, millisecond: c }, t)
        );
    }
    static fromJSDate(t, e = {}) {
        ...
        return n.isValid ? new v({ ts: i, zone: n, loc: N.fromObject(e) }) : v.invalid(hn(n));
    }
    static fromMillis(t, e = {}) {
        if (zt(t))
            return t < -fc || t > fc
                ? v.invalid('Timestamp out of range')
                : new v({ ts: t, zone: Et(e.zone, z.defaultZone), loc: N.fromObject(e) });
        throw new st(
    ...
    static fromSeconds(t, e = {}) {
        if (zt(t))
            return new v({ ts: t * 1e3, zone: Et(e.zone, z.defaultZone), loc: N.fromObject(e) });
    ...
    static fromObject(t, e = {}) {
        ...
        if ((f || h) && m)
            throw new vt("Can't mix weekYear/weekNumber units with year/month/day or ordinals");
    ...
    static fromFormat(t, e, i = {}) {
        if (D(t) || D(e)) throw new st('fromFormat requires an input string and a format');
    ...
    static invalid(t, e = null) {
        if (!t) throw new st('need to specify a reason the DateTime is invalid');
        let i = t instanceof rt ? t : new rt(t, e);
    ...
    reconfigure({ locale: t, numberingSystem: e, outputCalendar: i } = {}) {
        let n = this.loc.clone({ locale: t, numberingSystem: e, outputCalendar: i });
    ...
    toLocaleString(t = ae, e = {}) {
        return this.isValid ? X.create(this.loc.clone(e), t).formatDateTime(this) : ro;
    }
    toLocaleParts(t = {}) {
    ...
    toISOTime({
        ...
        return this.isValid ? (n ? 'T' : '') + gc(this, o === 'extended', e, t, i, r) : null;
    }
    toRFC2822() {
    ...
    toSQLTime({ includeOffset: t = !0, includeZone: e = !1, includeOffsetSpace: i = !0 } = {}) {
        let n = 'HH:mm:ss.SSS';
        return (e || t) && (i && (n += ' '), e ? (n += 'z') : t && (n += 'ZZ')), dn(this, n, !0);
    }
    toSQL(t = {}) {
    ...
    diff(t, e = 'milliseconds', i = {}) {
        if (!this.isValid || !t.isValid) return C.invalid('created by diffing an invalid DateTime');
        let n = { locale: this.locale, numberingSystem: this.numberingSystem, ...i },
    ...
    static min(...t) {
        if (!t.every(v.isDateTime)) throw new st('min requires all arguments be DateTimes');
        return Yr(t, (e) => e.valueOf(), Math.min);
    }
    static max(...t) {
        if (!t.every(v.isDateTime)) throw new st('max requires all arguments be DateTimes');
        ...
        return s === null || i === 'undefined'
            ...
            : (i === 'number'
                  ...
                  : i === 'string'
                    ...
                    : s instanceof Date
                      ? (s = v.fromJSDate(s, e))
                      : i === 'object' && !(s instanceof v) && (s = v.fromObject(s, e)),
    ...
    return {
        ...
        initChart: function (i = null) {
            ...
            return (
                ...
                new Rt(this.$refs.canvas, { type: e, data: i ?? s, options: t })
            );
        },
        getChart: function () {
