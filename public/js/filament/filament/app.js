(() => {
    var Z = Object.create,
        ...
        ae = (o) => L(o, '__esModule', { value: !0 }),
        ie = (o, n) => () => (n || ((n = { exports: {} }), o(n.exports, n)), n.exports),
        se = (o, n, p) => {
            ...
            (function (p, d, P) {
                ...
                function J() {
                    if (!S) {
                        S = {};
                        for (var e in h)
                            (e > 95 && e < 112) || (h.hasOwnProperty(e) && (S[h[e]] = e));
                    }
                    return S;
                }
                function U(e, t, a) {
                ...
                function I(e, t) {
                    ...
                    for (a = X(e), b = 0; b < a.length; ++b)
                        (c = a[b]),
                            q[c] && (c = q[c]),
                            t && t != 'keypress' && g[c] && ((c = g[c]), M.push('shift')),
                            C(c) && M.push(c);
                    return (t = U(c, M, t)), { key: c, modifiers: M, action: t };
                }
                function D(e, t) {
                ...
                function v(e) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                !(!i && _.seq && a[_.seq] != _.level) &&
                                    k == _.action &&
                                    ((k == 'keypress' && !l.metaKey && !l.ctrlKey) ||
                                        $(s, _.modifiers)))
                            ) {
                                var Q = !i && _.combo == u,
                    ...
                    function x(r, s, l, i) {
                        t.stopCallback(s, s.target || s.srcElement, l, i) ||
                            (r(s, l) === !1 && (V(s), H(s)));
                    }
                    t._handleKey = function (r, s, l) {
                        var i = j(r, s, l),
                            u,
                            m = {},
                            f = 0,
                        ...
                        var A = l.type == 'keypress' && M;
                        l.type == E && !C(r) && !A && K(m), (M = _ && l.type == 'keydown');
                    };
                    function G(r) {
                    ...
                    function z(r, s, l, i) {
                        ...
                        for (var f = 0; f < s.length; ++f) {
                            var _ = f + 1 === s.length,
                                A = _ ? m : u(i || I(s[f + 1]).action);
                            N(s[f], A, i, r, f);
                        }
                    }
                    function N(r, s, l, i, u) {
                        (t._directMap[r + ':' + l] = s), (r = r.replace(/\s+/g, ' '));
                        var m = r.split(' '),
                            f;
                        if (m.length > 1) {
                            z(r, m, s, l);
                    ...
                    (t._bindMultiple = function (r, s, l) {
                        for (var i = 0; i < r.length; ++i) N(r[i], s, l);
                    }),
                        O(e, 'keypress', G),
                        O(e, 'keydown', G),
                        O(e, 'keyup', G);
                ...
                (v.prototype.bind = function (e, t, a) {
                    ...
                    (v.prototype.stopCallback = function (e, t) {
                        var a = this;
                        if ((' ' + t.className + ' ').indexOf(' mousetrap ') > -1 || D(t, a.target))
                            return !1;
    ...
    (function (o) {
        if (o) {
            var n = {},
                p = o.prototype.stopCallback;
            (o.prototype.stopCallback = function (d, P, h, y) {
                var g = this;
                return g.paused ? !0 : n[h] || n[y] ? !1 : p.call(g, d, P, h);
            }),
                (o.prototype.bindGlobal = function (d, P, h) {
                    var y = this;
                    if ((y.bind(d, P, h), d instanceof Array)) {
    ...
    var le = (o) => {
            o.directive('mousetrap', (n, { modifiers: p, expression: d }, { evaluate: P }) => {
                let h = () => (d ? P(d) : n.click());
                (p = p.map((y) => y.replace('-', '+'))),
                    p.includes('global') &&
    ...
    document.addEventListener('alpine:init', () => {
        ...
        let o = localStorage.getItem('theme') ?? 'system';
        window.Alpine.store(
            'theme',
            o === 'dark' ||
                (o === 'system' && window.matchMedia('(prefers-color-scheme: dark)').matches)
                ? 'dark'
                : 'light',
        ),
