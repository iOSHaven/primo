function c() {
    return {
        ...
        toggleSelectRecordsInGroup: async function (e) {
            ...
            this.selectRecords(await this.$wire.getGroupedSelectableTableRecordKeys(e)),
                (this.isLoading = !1);
        },
        getRecordsInGroupOnPage: function (e) {
            let s = [];
            for (let t of this.$root.getElementsByClassName('fi-ta-record-checkbox'))
                t.dataset.group === e && s.push(t.value);
            return s;
        },
