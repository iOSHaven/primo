                    ...
                    (function () {
                        ...
                        return (
                            ...
                            (g.prototype.delete = function (x) {
                                var b;
                                return (b = this.values.indexOf(x)) === -1
                                    ? !1
                                    : (this.values.splice(b, 1), !0);
                            }),
            ...
            x ||
                    ...
                    function h(D) {
                        return (
                            (window.ShadowDOMPolyfill &&
                                window.ShadowDOMPolyfill.wrapIfNeeded(D)) ||
                            D
                        );
                    }
                    function o() {
                    ...
                    if (!b.JsMutationObserver) {
                        ...
                        d.prototype = {
                            observe: function (D, R) {
                                ...
                                w || ((w = new t(this, D, R)), E.push(w), this.nodes_.push(D)),
                                    w.addListeners();
                            },
                            disconnect: function () {
                        ...
                        (t.prototype = {
                            ...
                            addListeners_: function (D) {
                                ...
                                R.attributes && D.addEventListener('DOMAttrModified', this, !0),
                                    R.characterData &&
                                        D.addEventListener('DOMCharacterDataModified', this, !0),
                                    R.childList && D.addEventListener('DOMNodeInserted', this, !0),
                                    (R.childList || R.subtree) &&
                                        D.addEventListener('DOMNodeRemoved', this, !0);
                            },
                            ...
                            removeListeners_: function (D) {
                                ...
                                R.attributes && D.removeEventListener('DOMAttrModified', this, !0),
                                    R.characterData &&
                                        D.removeEventListener('DOMCharacterDataModified', this, !0),
                                    R.childList &&
                                        D.removeEventListener('DOMNodeInserted', this, !0),
                                    (R.childList || R.subtree) &&
                                        D.removeEventListener('DOMNodeRemoved', this, !0);
                            },
                            ...
                            handleEvent: function (D) {
                                switch ((D.stopImmediatePropagation(), D.type)) {
                                    case 'DOMAttrModified':
                                        ...
                                        var k =
                                            D.attrChange === MutationEvent.ADDITION
                                                ? null
                                                : D.prevValue;
                                        a(w, function (M) {
                                            return !M.attributes ||
                                    ...
                                    case 'DOMCharacterDataModified':
                                        var w = D.target,
                                            ...
                                            k = D.prevValue;
                                        a(w, function (M) {
                                            return M.characterData
                                                ? M.characterDataOldValue
                                                    ? n(k)
                                                    : B
                                                : void 0;
                                        });
                            ...
                            b.MutationObserver ||
                                ((b.MutationObserver = d), (d._isPolyfilled = !0));
                    }
                })(self),
                (function () {
                    'use strict';
                    ...
                    if (
                        ((!window.CustomEvent || (o && typeof window.CustomEvent != 'function')) &&
                            ((window.CustomEvent = function (a, d) {
                                ...
                                return (
                                    i.initCustomEvent(a, !!d.bubbles, !!d.cancelable, d.detail), i
                                );
                            }),
                ...
                window.CustomElements.addModule(function (b) {
                    ...
                    function h(i, u, s) {
                        ...
                        if (!n)
                            for (n = i.firstChild; n && n.nodeType !== Node.ELEMENT_NODE; )
                                n = n.nextSibling;
                    ...
                    function a(i, u, s) {
                        if (((i = window.wrap(i)), !(s.indexOf(i) >= 0))) {
                            ...
                            for (
                                var n,
                                    p = i.querySelectorAll('link[rel=' + d + ']'),
                                    c = 0,
                                    v = p.length;
                                v > c && (n = p[c]);
                                c++
                ...
                window.CustomElements.addModule(function (b) {
                    ...
                    function p(E) {
                        for (var w = E, k = window.wrap(document); w; ) {
                            ...
                            w =
                                w.parentNode ||
                                (w.nodeType === Node.DOCUMENT_FRAGMENT_NODE && w.host);
                        }
                    }
                    function c(E) {
                    ...
                    function v(E, w) {
                        if (f.dom) {
                            ...
                            if (k && k.type === 'childList' && k.addedNodes && k.addedNodes) {
                                for (var T = k.addedNodes[0]; T && T !== document && !T.host; )
                                    T = T.parentNode;
                                var N =
                                    (T && (T.URL || T._URL || (T.host && T.host.localName))) || '';
                    ...
                    function l(E) {
                        (E = window.wrap(E)),
                            f.dom && console.group('upgradeDocument: ', E.baseURI.split('/').pop());
                ...
                window.CustomElements.addModule(function (b) {
                    function y(i, u) {
                        if (
                            ...
                            var s = i.getAttribute('is'),
                                n =
                                    b.getRegisteredDefinition(i.localName) ||
                                    b.getRegisteredDefinition(s);
                            if (n && ((s && n.tag == i.localName) || (!s && !n.extends)))
                                return h(i, n, u);
                        }
                    }
                    function h(i, u, s) {
                    ...
                    function o(i, u) {
                        Object.__proto__ || e(i, u.prototype, u.native),
                            ...
                            for (var c, v = Object.getOwnPropertyNames(p), t = 0; (c = v[t]); t++)
                                n[c] ||
                                    (Object.defineProperty(
                                        i,
                                        c,
                                        Object.getOwnPropertyDescriptor(p, c),
                                    ),
                                    (n[c] = 1));
                ...
                window.CustomElements.addModule(function (b) {
                    ...
                    function o(E, w, k) {
                        ...
                        this.attributeChangedCallback &&
                            N !== T &&
                            this.attributeChangedCallback(E, T, N);
                    }
                    function e(E) {
                    ...
                    function d(E) {
                        for (var w, k = E.extends, T = 0; (w = E.ancestry[T]); T++)
                            k = w.is && w.tag;
                    ...
                    this.Trix = {
                        ...
                        browser: {
                            ...
                            supportsInputEvents: (function () {
                                ...
                                for (
                                    h = ['data', 'getTargetRanges', 'inputType'],
                                        x = 0,
                                        b = h.length;
                                    b > x;
                                    x++
                    ...
                    g.BasicObject = (function () {
                        ...
                        return (
                                ...
                                return (
                                    ...
                                    (this.prototype[e] = function () {
                                        ...
                                        return (
                                            ...
                                            a
                                                ? ((n = s?.[e]),
                                                  n != null ? b.call(n, s, arguments) : void 0)
                            ...
                            (y = function (o) {
                                var e, a;
                                if (!(a = o.match(h)))
                                    throw new Error("can't parse @proxyMethod expression: " + o);
                                return (
                                    (e = { name: a[4] }),
                                ...
                                (h.prototype.inspect = function () {
                                    ...
                                    return (
                                        (e = function () {
                                            var i, u, s;
                                            (u =
                                                (i = this.contentsForInspection()) != null
                                                    ? i
                                                    : {}),
                                                (s = []);
...
`,
                            ...
                            breakableWhitespacePattern: RegExp(
                                '[^\\S' + g.NON_BREAKING_SPACE + ']',
                            ),
                            squishBreakableWhitespace: function (y) {
                                return y
                                    .replace(
                                        RegExp('' + g.breakableWhitespacePattern.source, 'g'),
                                        ' ',
                                    )
                                    .replace(/\ {2,}/g, ' ');
                            },
                            ...
                            (x = function (y, h) {
                                var o, e, a;
                                for (
                                    o = 0, e = y.length, a = h.length;
                                    e > o && y.charAt(o).isEqualTo(h.charAt(o));
                        ...
                        g.extend({
                            arraysAreEqual: function (b, y) {
                                ...
                                if (
                                    ...
                                    return !1;
                                for (o = h = 0, e = b.length; e > h; o = ++h)
                                    if (((a = b[o]), a !== y[o])) return !1;
                                return !0;
                            },
                            ...
                            summarizeArrayChange: function (b, y) {
                                ...
                                for (i = 0, n = b.length; n > i; i++)
                                    (c = b[i]), o.has(c) || p.push(c);
                                ...
                                getAllAttributeNames: function () {
                                    return (
                                        ...
                                        (x = g
                                            ...
                                            .concat(g.getBlockAttributeNames()))
                                    );
                                },
                                ...
                                getListAttributeNames: function () {
                                    ...
                                    return (
                                        ...
                                        (y = (function () {
                                            ...
                                            for (o in a)
                                                (e = a[o].listAttribute), e != null && d.push(e);
                                            return d;
                                        })())
                                    );
                                },
                    ...
                    function () {
                        ...
                        (x = document.documentElement),
                            (b =
                                (y =
                                    (h =
                                        (o = x.matchesSelector) != null
                                            ? o
                                            : x.webkitMatchesSelector) != null
                                        ? h
                            ...
                            g.extend({
                                    ...
                                    return (
                                        ...
                                        (s = function (m) {
                                            ...
                                            return (
                                                ...
                                                (C = g.findClosestElementFromNode(m.target, {
                                                    matchingSelector: r,
                                                })),
                                                C != null && (f?.call(C, m, C), v)
                                                    ? m.preventDefault()
                                                    : void 0
                                            );
                                        }),
                                ...
                                handleEventOnce: function (a, d) {
                                    return (
                                        d == null && (d = {}), (d.times = 1), g.handleEvent(a, d)
                                    );
                                },
                                ...
                                innerElementIsActive: function (a) {
                                    return (
                                        ...
                                        g.elementContainsNode(a, document.activeElement)
                                    );
                                },
                                ...
                                findElementFromContainerAndOffset: function (a, d) {
                                    var i;
                                    return (
                                        (i = g.findNodeFromContainerAndOffset(a, d)),
                                        g.findClosestElementFromNode(i)
                                    );
                                },
                                ...
                                removeNode: function (a) {
                                    var d;
                                    return a != null && (d = a.parentNode) != null
                                        ? d.removeChild(a)
                                        : void 0;
                                },
                                ...
                                tagName: function (a) {
                                    var d;
                                    return a != null && (d = a.tagName) != null
                                        ? d.toLowerCase()
                                        : void 0;
                                },
                                makeElement: function (a, d) {
                                    ...
                                    if (d.className)
                                        for (
                                            f = d.className.split(' '), n = 0, v = f.length;
                                            v > n;
                                            n++
                                        )
                                            (u = f[n]), s.classList.add(u);
                                    if (
                                        (d.textContent && (s.textContent = d.textContent),
                                        d.childNodes)
                                    )
                                        for (
                                            m = [].concat(d.childNodes), p = 0, t = m.length;
                                            t > p;
                                            p++
                                        )
                                ...
                                nodeProbablyIsBlockContainer: function (a) {
                                    ...
                                    return (
                                        ...
                                        e.call(g.getBlockTagNames(), d) >= 0 &&
                                            ((i = g.tagName(a.firstChild)),
                                            e.call(g.getBlockTagNames(), i) < 0)
                                    );
                                },
                                        ...
                                        a
                                            ? g.nodeIsTextNode(a)
                                                ? a.data === g.ZERO_WIDTH_SPACE
                                                    ? i
                                                        ? a.parentNode.dataset.trixCursorTarget ===
                                                          i
                                                        : !0
                                                    : void 0
                                ...
                                nodeIsAttachmentElement: function (a) {
                                    return g.elementMatchesSelector(
                                        a,
                                        g.AttachmentView.attachmentSelector,
                                    );
                                },
                        ...
                        (x = g.copyObject),
                            ...
                            g.extend({
                                ...
                                rangeIsCollapsed: function (e) {
                                    var a, d, i;
                                    if (e != null)
                                        return (d = y(e)), (i = d[0]), (a = d[1]), o(i, a);
                                },
                    ...
                    function () {
                        ...
                        (g.registerElement = function (d, i) {
                            ...
                            (x = function () {
                                var d;
                                return (d = b('trix-csp-nonce') || b('csp-nonce'))
                            ...
                            (e = function (d) {
                                ...
                                u = {};
                                for (i in d)
                                    (s = d[i]), (u[i] = typeof s == 'function' ? { value: s } : s);
                                return u;
                            }),
                            (a = (function () {
                                var d;
                                return (
                                    (d = function (i) {
                                        ...
                                        for (
                                            u = {},
                                                c = ['initialize', 'connect', 'disconnect'],
                                                s = 0,
                                                p = c.length;
                                            p > s;
                                            s++
                    ...
                    function () {
                        ...
                        g.extend({
                            ...
                            getDOMRange: function () {
                                var y, h;
                                return (y =
                                    (h = g.getDOMSelection()) != null ? h.getRangeAt(0) : void 0) &&
                                    !x(y)
                                    ? y
                                    : void 0;
                            },
                            ...
                            g.extend({
                                dataTransferIsPlainText: function (b) {
                                    ...
                                    return (
                                        ...
                                        o && h
                                            ? ((y = new DOMParser().parseFromString(
                                                  h,
                                                  'text/html',
                                              ).body),
                            ...
                            (g.Hash = (function (h) {
                                ...
                                return (
                                    ...
                                    (a = function (s, n) {
                                        var p, c, v, t, r;
                                        for (
                                            t = {}, r = Object.keys(s).sort(), p = 0, v = r.length;
                                            v > p;
                                            p++
                                        )
                                            (c = r[p]), c !== n && (t[c] = s[c]);
                                    ...
                                    for (
                                        ...
                                        if (((u = b[d]), a)) {
                                            if (
                                                ...
                                                u.canBeGrouped(e) &&
                                                typeof (o = a[a.length - 1]).canBeGroupedWith ==
                                                    'function' &&
                    ...
                    function () {
                        ...
                        g.ObjectMap = (function (y) {
                            function h(o) {
                                var e, a, d, i, u;
                                for (
                                    o == null && (o = []), this.objects = {}, d = 0, i = o.length;
                                    i > d;
                                    d++
                                )
                                    (u = o[d]),
                                        (a = JSON.stringify(u)),
                                        (e = this.objects)[a] == null && (e[a] = u);
                            }
                            return (
                                x(h, y),
                        ...
                        (g.UTF16String = (function (d) {
                            ...
                            (x =
                                (typeof Array.from == 'function'
                                    ? Array.from('\u{1F47C}').length
                                    : void 0) === 1),
                            (b =
                                (typeof ' '.codePointAt == 'function'
                                    ? ' '.codePointAt(0)
                                    : void 0) != null),
                            (y =
                    ...
                    function () {
                        ...
                        g.config.blockAttributes = x = {
                            ...
                            bullet: {
                                ...
                                test: function (b) {
                                    return (
                                        g.tagName(b.parentNode) === x[this.listAttribute].tagName
                                    );
                                },
                            },
                            ...
                            bold: {
                                ...
                                parser: function (x) {
                                    ...
                                    return (
                                        ...
                                        b.fontWeight === 'bold' || b.fontWeight >= 600
                                    );
                                },
                            },
                            italic: {
                                ...
                                parser: function (x) {
                                    var b;
                                    return (
                                        (b = window.getComputedStyle(x)), b.fontStyle === 'italic'
                                    );
                                },
                            },
                            href: {
                                ...
                                parser: function (x) {
                                    ...
                                    return (
                                        ...
                                        (h = 'a:not(' + b + ')'),
                                        (y = g.findClosestElementFromNode(x, {
                                            matchingSelector: h,
                                        }))
                                            ? y.getAttribute('href')
                                            : void 0
                            ...
                            g.extend({
                                serializers: {
                                    ...
                                    'text/html': function (e) {
                                        ...
                                        for (
                                            f = u.querySelectorAll(o), s = 0, v = f.length;
                                            v > s;
                                            s++
                                        )
                                        ...
                                        for (
                                            C = u.querySelectorAll(y), c = 0, l = C.length;
                                            l > c;
                                            c++
                                        ) {
                                            i = C[c];
                                            try {
                                                (d = JSON.parse(i.getAttribute(b))),
                                                    i.removeAttribute(b);
                        ...
                        g.ObjectView = (function (h) {
                            ...
                            return (
                                ...
                                (o.prototype.invalidateViewForObject = function (e) {
                                    var a;
                                    return (a = this.findViewForObject(e)) != null
                                        ? a.invalidate()
                                        : void 0;
                                }),
                                ...
                                (o.prototype.createChildView = function (e, a, d) {
                                    ...
                                    return (
                                        d == null && (d = {}),
                                        a instanceof g.ObjectGroup &&
                                            ((d.viewClass = e), (e = g.ObjectGroupView)),
                                        (i = new e(a, d)),
                                ...
                                (o.prototype.getAllChildViews = function () {
                                    var e, a, d, i, u;
                                    for (
                                        u = [], i = this.childViews, a = 0, d = i.length;
                                        d > a;
                                        a++
                                    )
                                ...
                                (o.prototype.findViewForObject = function (e) {
                                    var a, d, i, u;
                                    for (
                                        i = this.getAllChildViews(), a = 0, d = i.length;
                                        d > a;
                                        a++
                                    )
                                ...
                                (o.prototype.getCachedViewForObject = function (e) {
                                    var a;
                                    return (a = this.getViewCache()) != null
                                        ? a[e.getCacheKey()]
                                        : void 0;
                                }),
                                (o.prototype.cacheViewForObject = function (e, a) {
                                    var d;
                                    return (d = this.getViewCache()) != null
                                        ? (d[a.getCacheKey()] = e)
                                        : void 0;
                                }),
                            ...
                            return (
                                ...
                                (h.prototype.getChildViews = function () {
                                    ...
                                    if (!this.childViews.length)
                                        for (
                                            d = this.objectGroup.getObjects(), o = 0, e = d.length;
                                            e > o;
                                            o++
                                        )
                                            (a = d[o]),
                                ...
                                (h.prototype.createNodes = function () {
                                    ...
                                    for (
                                        ...
                                        for (
                                            p = s[e], n = p.getNodes(), a = 0, i = n.length;
                                            i > a;
                                            a++
                                        )
                            ...
                            (g.MutationObserver = (function (s) {
                                ...
                                return (
                                    ...
                                    (n.prototype.didMutate = function (r) {
                                        var l, A;
                                        return (
                                            (l = this.mutations).push.apply(
                                                l,
                                                this.findSignificantMutations(r),
                                            ),
                                    ...
                                    (n.prototype.mutationIsSignificant = function (r) {
                                        ...
                                        for (
                                            m = this.nodesModifiedByMutation(r),
                                                l = 0,
                                                A = m.length;
                                            A > l;
                                            l++
                                    ...
                                    (n.prototype.nodeIsSignificant = function (r) {
                                        return (
                                            r !== this.element && !this.nodeIsMutable(r) && !y(r)
                                        );
                                    }),
                                    ...
                                    (n.prototype.nodesModifiedByMutation = function (r) {
                                        ...
                                        switch (((l = []), r.type)) {
                                            ...
                                            case 'characterData':
                                                ...
                                                break;
                                            case 'childList':
                                                l.push.apply(l, r.addedNodes),
                                                    l.push.apply(l, r.removedNodes);
                                        }
                                        return l;
                                    }),
                                    ...
                                    (n.prototype.getMutationsByType = function (r) {
                                        var l, A, f, m, C;
                                        for (
                                            m = this.mutations, C = [], l = 0, A = m.length;
                                            A > l;
                                            l++
                                        )
                                    ...
                                    (n.prototype.getTextChangesFromChildList = function () {
                                        ...
                                        for (
                                            ...
                                            (m = C[l]),
                                                r.push.apply(r, m.addedNodes),
                                                S.push.apply(S, m.removedNodes);
                                        return (
                        ...
                        (x = g.handleEvent),
                            ...
                            (g.InputController = (function (o) {
                                function e(a) {
                                    var d;
                                    (this.element = a),
                                        (this.mutationObserver = new g.MutationObserver(
                                            this.element,
                                        )),
                                    ...
                                    for (d in this.events)
                                        x(d, {
                                            ...
                                            withCallback: this.handlerFor(d),
                                        });
                                }
                                return (
                                    y(e, o),
                                    ...
                                    (e.prototype.requestReparse = function () {
                                        ...
                                        return (
                                            (a = this.delegate) != null &&
                                                typeof a.inputControllerDidRequestReparse ==
                                                    'function' &&
                                        ...
                                        return (
                                            (i = (function () {
                                                ...
                                                for (n = [], u = 0, s = a.length; s > u; u++)
                                                    (d = a[u]),
                                                        n.push(new g.FileVerificationOperation(d));
                                                return n;
                                            })()),
                                            Promise.all(i).then(
                                                (function (u) {
                                        ...
                                        try {
                                            return (
                                                (d = this.delegate) != null &&
                                                    d.inputControllerWillHandleInput(),
                                                a.call(this)
                                            );
                                        } finally {
                                    ...
                                    (l.prototype.elementDidMutate = function (f) {
                                        ...
                                        return this.isComposing()
                                            ? (m = this.delegate) != null &&
                                              typeof m.inputControllerDidAllowUnhandledInput ==
                                                  'function'
...
` && !C),
                                        ...
                                        dragover: function (f) {
                                            ...
                                            return (!this.draggedRange &&
                                                ...
                                                : ((this.draggingPoint = m),
                                                  ...
                                                  typeof C.inputControllerDidReceiveDragOverPoint ==
                                                      'function'
                                        ...
                                        dragend: function () {
                                            ...
                                            return (
                                                (f = this.delegate) != null &&
                                                    typeof f.inputControllerDidCancelDrag ==
                                                        'function' &&
                                    ...
                                    (l.prototype.keys = {
                                        ...
                                        tab: function (f) {
                                            var m, C;
                                            return (m = this.responder) != null &&
                                                m.canIncreaseNestingLevel()
                                                ? ((C = this.responder) != null &&
                                                      C.increaseNestingLevel(),
                                                  this.requestRender(),
                                                  f.preventDefault())
                                                : void 0;
                                        },
...
`),
                                            ...
                                            tab: function (f) {
                                                var m, C;
                                                return (m = this.responder) != null &&
                                                    m.canDecreaseNestingLevel()
                                                    ? ((C = this.responder) != null &&
                                                          C.decreaseNestingLevel(),
                                                      this.requestRender(),
                                                      f.preventDefault())
                                                    : void 0;
                                            },
                                    ...
                                    (l.prototype.serializeSelectionToDataTransfer = function (f) {
                                        ...
                                        if (h(f))
                                            return (
                                                ...
                                                f.setData(
                                                    'text/html',
                                                    g.DocumentView.render(m).innerHTML,
                                                ),
                                                f.setData(
                                                    'text/plain',
                                                    m.toString().replace(/\n$/, ''),
                            ...
                            (o = function (r) {
                                var l, A;
                                return (l = r.type) != null && (A = l.match(/\/(\w+)$/)) != null
                                    ? A[1]
                                    : void 0;
                            }),
                            (e =
                            ...
                            (x = (function (r) {
                                ...
                                return (
                                    ...
                                    (l.prototype.canApplyToDocument = function () {
                                        var A, f;
                                        return (
                                            ((A = this.data.start) != null ? A.length : void 0) ===
                                                0 &&
                                    ...
                                    (i.prototype.events = {
                                        keydown: function (t) {
                                            ...
                                            if (b(t)) {
                                                if (
                                                    ((r = s(t)),
                                                    (f = this.delegate) != null
                                                        ? f.inputControllerDidReceiveKeyboardCommand(
                                                              r,
                                                          )
                                                        : void 0)
                                                )
                                            ...
                                            return n(t)
                                                ...
                                                : p(t)
                                                  ? (t.preventDefault(),
                                                    (l = {
                                                        type: 'text/plain',
                                                        string: t.clipboardData.getData(
                                                            'text/plain',
                                                        ),
                                                    }),
                                                    (A = this.delegate) != null &&
                                                        A.inputControllerWillPaste(l),
                                                    (f = this.responder) != null &&
                                                        f.insertString(l.string),
                                                    this.render(),
                                                    (m = this.delegate) != null
                                                        ? m.inputControllerDidPaste(l)
                                                        : void 0)
                                                  : (r =
                                                          (C = t.clipboardData) != null
                                                              ? C.getData('URL')
                                                              : void 0)
                                                    ? (t.preventDefault(),
                                                      (l = {
                                                          type: 'text/html',
                                                          html: this.createLinkHTML(r),
                                                      }),
                                        ...
                                        dragstart: function (t) {
                                            ...
                                            return (r = this.responder) != null &&
                                                r.selectionContainsAttachments()
                                            ...
                                            return this.dragging
                                                ...
                                                : u(t)
                                                  ? (t.preventDefault(),
                                                    (r = c(t)),
                                                    (f = this.responder) != null &&
                                                        f.setLocationRangeFromPointRange(r),
...
`);
                                    ...
                                    (i.prototype.insertString = function (t, r) {
                                        ...
                                        return (
                                            t == null && (t = ''),
                                            (l = this.delegate) != null &&
                                                l.inputControllerWillPerformTyping(),
                                            this.withTargetDOMRange(function () {
                                                var A;
                                    ...
                                    (i.prototype.toggleAttributeIfSupported = function (t) {
                                        ...
                                        return a.call(g.getAllAttributeNames(), t) >= 0
                                            ? ((r = this.delegate) != null &&
                                                  r.inputControllerWillPerformFormatting(t),
                                              this.withTargetDOMRange(function () {
                                                  var l;
                                                  return (l = this.responder) != null
                                    ...
                                    (i.prototype.activateAttributeIfSupported = function (t, r) {
                                        ...
                                        return a.call(g.getAllAttributeNames(), t) >= 0
                                            ? ((l = this.delegate) != null &&
                                                  l.inputControllerWillPerformFormatting(t),
                                              this.withTargetDOMRange(function () {
                                                  var A;
                                                  return (A = this.responder) != null
                                    ...
                                    (i.prototype.getTargetDOMRange = function (t) {
                                        ...
                                        return (
                                            ...
                                            (f =
                                                typeof (r = this.event).getTargetRanges ==
                                                'function'
                                                    ? r.getTargetRanges()
                                                    : void 0) &&
                                            f.length &&
                            ...
                            (g.AttachmentEditorController = (function (n) {
                                ...
                                return (
                                    ...
                                    (p.prototype.uninstall = function () {
                                        var v, t;
                                        for (this.savePendingCaption(); (t = this.undos.pop()); )
                                            t();
                                    ...
                                    (p.prototype.installCaptionEditor = c(function () {
                                        ...
                                        return (
                                            ...
                                            (t = r.cloneNode()),
                                            {
                                                ...
                                                undo: function () {
                                                    return (
                                                        g.removeNode(t), (r.style.display = null)
                                                    );
                                                },
                                            }
                                        );
                                        ...
                                        switch ((t = v.target.getAttribute('data-trix-action'))) {
                                            case 'remove':
                                                return (r = this.delegate) != null
                                                    ? r.attachmentEditorDidRequestRemovalOfAttachment(
                                                          this.attachment,
                                                      )
                                                    : void 0;
                                        }
                                    ...
                                    (p.prototype.didKeyDownCaption = function (v) {
                                        ...
                                        return h[v.keyCode] === 'return'
                                            ? (v.preventDefault(),
                                              ...
                                              (t = this.delegate) != null &&
                                              typeof t.attachmentEditorDidRequestDeselectingAttachment ==
                                                  'function'
                                                  ? t.attachmentEditorDidRequestDeselectingAttachment(
                                                        this.attachment,
                                                    )
                                                  : void 0)
                                            : void 0;
                                    ...
                                    (p.prototype.didInputCaption = function (v) {
                                        return (this.pendingCaption = v.target.value
                                            .replace(/\s/g, ' ')
                                            .trim());
                                    }),
                                ...
                                return (
                                    ...
                                    (a.prototype.createNodes = function () {
                                        ...
                                        if (
                                            ...
                                            for (
                                                v = this.createContentNodes(), s = 0, p = v.length;
                                                p > s;
                                                s++
                                            )
                                    ...
                                    (a.prototype.createCaptionElement = function () {
                                        ...
                                        return (
                                            (s = y({
                                                tagName: 'figcaption',
                                                className: x.attachmentCaption,
                                            })),
                                            (i = this.attachmentPiece.getCaption())
                                                ? (s.classList.add(
                                                      x.attachmentCaption + '--edited',
                                                  ),
                                                  (s.textContent = i))
                                                : ((u = this.getCaptionConfig()),
                                                  u.name && (n = this.attachment.getFilename()),
                                                  u.size &&
                                                      (c = this.attachment.getFormattedFilesize()),
                                                  n &&
                                                      ((p = y({
                                                          tagName: 'span',
                                                          className: x.attachmentName,
                                    ...
                                    (a.prototype.getClassName = function () {
                                        ...
                                        return (
                                            (u = [
                                                x.attachment,
                                                x.attachment + '--' + this.attachment.getType(),
                                            ]),
                                            (i = this.attachment.getExtension()) &&
                                                u.push(x.attachment + '--' + i),
                                            u.join(' ')
                                        );
                                    }),
                                    ...
                                    (a.prototype.getHref = function () {
                                        return b(this.attachment.getContent(), 'a')
                                            ? void 0
                                    ...
                                    (a.prototype.findProgressElement = function () {
                                        var i;
                                        return (i = this.findElement()) != null
                                            ? i.querySelector('progress')
                                            : void 0;
                                    }),
                                    (d = function (i) {
                                        return y({
                                    ...
                                    (a.prototype.attachmentDidChangeUploadProgress = function () {
                                        ...
                                        return (
                                            ...
                                            (i = this.findProgressElement()) != null
                                                ? (i.value = u)
                                                : void 0
                                        );
                                    }),
                            ...
                            (g.PreviewableAttachmentView = (function (h) {
                                ...
                                return (
                                    ...
                                    (o.prototype.createCaptionElement = function () {
                                        var e;
                                        return (
                                            (e = o.__super__.createCaptionElement.apply(
                                                this,
                                                arguments,
                                            )),
                                            e.textContent ||
                                ...
                                return (
                                    ...
                                    (a.prototype.createNodes = function () {
                                        ...
                                        if (
                                            ...
                                            for (s = x(i), u = 0, n = c.length; n > u; u++)
                                                (p = c[u]), s.appendChild(p);
                                            c = [i];
                                        }
                                        return c;
                                    }),
                                    (a.prototype.createAttachmentNodes = function () {
                                        ...
                                        return (
                                            (i = this.attachment.isPreviewable()
                                                ...
                                                : g.AttachmentView),
                                            (u = this.createChildView(i, this.piece.attachment, {
                                                piece: this.piece,
                                            })),
                                            u.getNodes()
                                        );
                        ...
                        g.TextView = (function (y) {
                            ...
                            return (
                                ...
                                (h.prototype.getPieces = function () {
                                    var e, a, d, i, u;
                                    for (
                                        i = this.text.getPieces(), u = [], e = 0, a = i.length;
                                        a > e;
                                        e++
                                    )
                                    ...
                                    (a.prototype.createNodes = function () {
                                        ...
                                        if (
                                            ...
                                            this.block.isEmpty()
                                                ? c.push(y('br'))
                                                : ((r =
                                                      (v = b(this.block.getLastAttribute())) != null
                                                          ? v.text
                                                          : void 0),
                            ...
                            (g.DocumentView = (function (o) {
                                ...
                                return (
                                    ...
                                    (e.prototype.setDocument = function (u) {
                                        return u.isEqualTo(this.document)
                                            ? void 0
                                            : (this.document = this.object = u);
                                    }),
                                    (e.prototype.render = function () {
                                        ...
                                        if (
                                            ...
                                            for (
                                                ...
                                                (p = c[u]),
                                                    (t = this.findOrCreateCachedChildView(
                                                        g.BlockView,
                                                        p,
                                                    )),
                                                    v.push(
                                                        function () {
                                                            ...
                                                            for (
                                                                ...
                                                                (n = A[r]),
                                                                    f.push(
                                                                        this.shadowElement.appendChild(
                                                                            n,
                                                                        ),
                                                                    );
                                                            return f;
                                    ...
                                    (e.prototype.sync = function () {
                                        var u;
                                        for (
                                            u = this.createDocumentFragmentForSync();
                        ...
                        (y = g.findClosestElementFromNode),
                            ...
                            (g.CompositionController = (function (i) {
                                ...
                                return (
                                            ...
                                            (s = (function (c) {
                                                return function () {
                                                    ...
                                                    return c.focused
                                                        ...
                                                        : ((c.focused = !0),
                                                          (v = c.delegate) != null &&
                                                          typeof v.compositionControllerDidFocus ==
                                                              'function'
                                    ...
                                    (u.prototype.didClickAttachment = function (s, n) {
                                        ...
                                        return (
                                            ...
                                            typeof v.compositionControllerDidSelectAttachment ==
                                                'function'
                                                ? v.compositionControllerDidSelectAttachment(p, {
                                                      editCaption: c,
                                                  })
                                                : void 0
                                        );
                                    ...
                                    (u.prototype.render = function () {
                                        ...
                                        return (
                                            ...
                                            this.canSyncDocumentView() &&
                                                ...
                                                ((s = this.delegate) != null &&
                                                    typeof s.compositionControllerWillSyncDocumentView ==
                                                        'function' &&
                                                    s.compositionControllerWillSyncDocumentView(),
                                                this.documentView.sync(),
                                                (n = this.delegate) != null &&
                                                    typeof n.compositionControllerDidSyncDocumentView ==
                                                        'function' &&
                                    ...
                                    (u.prototype.installAttachmentEditorForAttachment = function (
                                        s,
                                        n,
                                    ) {
                                        var p, c, v;
                                        if (
                                            ((v = this.attachmentEditor) != null
                                                ? v.attachment
                                                : void 0) !== s &&
                                            ...
                                            return (
                                                ...
                                                (this.attachmentEditor =
                                                    new g.AttachmentEditorController(
                                                        p,
                                                        c,
                                                        this.element,
                                                        n,
                                    ...
                                    (u.prototype.uninstallAttachmentEditor = function () {
                                        var s;
                                        return (s = this.attachmentEditor) != null
                                            ? s.uninstall()
                                            : void 0;
                                    }),
                                    ...
                                    (u.prototype.attachmentEditorDidRequestUpdatingAttributesForAttachment =
                                        function (s, n) {
                                            var p;
                                            return (
                                                (p = this.delegate) != null &&
                                                    typeof p.compositionControllerWillUpdateAttachment ==
                                                        'function' &&
                                                    p.compositionControllerWillUpdateAttachment(n),
                                                this.composition.updateAttributesForAttachment(s, n)
                                            );
                                        }),
                                    (u.prototype.attachmentEditorDidRequestRemovingAttributeForAttachment =
                                        function (s, n) {
                                            var p;
                                            return (
                                                (p = this.delegate) != null &&
                                    ...
                                    (u.prototype.attachmentEditorDidRequestRemovalOfAttachment =
                                        function (s) {
                                            var n;
                                            return (n = this.delegate) != null &&
                                                typeof n.compositionControllerDidRequestRemovalOfAttachment ==
                                                    'function'
                                                ? n.compositionControllerDidRequestRemovalOfAttachment(
                                                      s,
                                                  )
                                                : void 0;
                                        }),
                                    (u.prototype.attachmentEditorDidRequestDeselectingAttachment =
                                        function (s) {
                                            var n;
                                            return (n = this.delegate) != null &&
                                                typeof n.compositionControllerDidRequestDeselectingAttachment ==
                                                    'function'
                    ...
                    function () {
                        ...
                        (b = g.handleEvent),
                            ...
                            (g.ToolbarController = (function (a) {
                                function d(f) {
                                    (this.element = f),
                                        (this.didKeyDownDialogInput = h(
                                            this.didKeyDownDialogInput,
                                            this,
                                        )),
                                        (this.didClickDialogButton = h(
                                            this.didClickDialogButton,
                                            this,
                                        )),
                                        (this.didClickAttributeButton = h(
                                            this.didClickAttributeButton,
                                            this,
                                        )),
                                        (this.didClickActionButton = h(
                                            this.didClickActionButton,
                                            this,
                                        )),
                                        (this.attributes = {}),
                                ...
                                return (
                                    ...
                                    (d.prototype.didKeyDownDialogInput = function (f, m) {
                                        ...
                                        return (
                                            f.keyCode === 13 &&
                                                ...
                                                this.setAttribute(S)),
                                            f.keyCode === 27
                                                ? (f.preventDefault(), this.hideDialog())
                                                : void 0
                                        );
                                    }),
                                    ...
                                    (d.prototype.eachActionButton = function (f) {
                                        var m, C, S, L, O;
                                        for (
                                            L = this.element.querySelectorAll(i),
                                                O = [],
                                                C = 0,
                                                S = L.length;
                                            S > C;
                                    ...
                                    (d.prototype.updateAttributes = function (f) {
                                        return (
                                            (this.attributes = f), this.refreshAttributeButtons()
                                        );
                                    }),
                                    ...
                                    (d.prototype.eachAttributeButton = function (f) {
                                        var m, C, S, L, O;
                                        for (
                                            L = this.element.querySelectorAll(s),
                                                O = [],
                                                C = 0,
                                                S = L.length;
                                            S > C;
                                    ...
                                    (d.prototype.dialogIsVisible = function (f) {
                                        var m;
                                        return (m = this.getDialog(f))
                                            ? m.hasAttribute('data-trix-active')
                                            : void 0;
                                    }),
                                    (d.prototype.toggleDialog = function (f) {
                                        return this.dialogIsVisible(f)
                                            ? this.hideDialog()
                                            : this.showDialog(f);
                                    }),
                                    (d.prototype.showDialog = function (f) {
                                        ...
                                        return (
                                            (m = t(S)) &&
                                                (O = l(S, f)) &&
                                                ((O.value =
                                                    (w = this.attributes[m]) != null ? w : ''),
                                                O.select()),
                                            (k = this.delegate) != null
                                                ? k.toolbarDidShowDialog(f)
                                                : void 0
                                        );
                                    }),
                                    ...
                                    (d.prototype.resetDialogInputs = function () {
                                        var f, m, C, S, L;
                                        for (
                                            S = this.element.querySelectorAll(p),
                                                L = [],
                                                f = 0,
                                                C = S.length;
                                            C > f;
                                        ...
                                        this.attributes.isEqualTo(a)
                                            ...
                                            : ((this.attributes = a),
                                              ...
                                              (d = this.previewDelegate) != null &&
                                                  typeof d.attachmentDidChangeAttributes ==
                                                      'function' &&
                                    ...
                                    return e !== this.getPreviewURL()
                                        ? ((this.previewURL = e),
                                          (a = this.previewDelegate) != null &&
                                              typeof a.attachmentDidChangeAttributes ==
                                                  'function' &&
                                    ...
                                    return (a = pieceList.getPieceAtIndex(0))
                                        ? ((o = a.attributes),
                                          ...
                                          pieceList.eachPiece(function (d) {
                                              return (
                                                  (e = o.getKeysCommonToHash(d.attributes)),
                                                  (o = o.slice(e))
                                              );
                                          }),
                                          o.toObject())
                                ...
                                (h.prototype.hasSameAttributesAsPiece = function (o) {
                                    return (
                                        ...
                                        (this.attributes === o.attributes ||
                                            this.attributes.isEqualTo(o.attributes))
                                    );
                                }),
                        ...
                        g.Piece.registerType(
                            ...
                            (g.AttachmentPiece = (function (y) {
                                ...
                                return (
                                    ...
                                    (h.fromJSON = function (o) {
                                        return new this(
                                            g.Attachment.fromJSON(o.attachment),
                                            o.attributes,
                                        );
                                    }),
                                    (h.permittedAttributes = ['caption', 'presentation']),
                                    (h.prototype.ensureAttachmentExclusivelyHasAttribute =
                                        function (o) {
                                            return this.hasAttribute(o)
                                                ? (this.attachment.hasAttribute(o) ||
                                                      this.attachment.setAttributes(
                                                          this.attributes.slice(o),
                                                      ),
                                    ...
                                    (h.prototype.removeProhibitedAttributes = function () {
                                        var o;
                                        return (
                                            (o = this.attributes.slice(
                                                this.constructor.permittedAttributes,
                                            )),
                                            o.isEqualTo(this.attributes)
                                                ? void 0
                                                : (this.attributes = o)
                                        );
                                    }),
                                    ...
                                    (h.prototype.getCaption = function () {
                                        var o;
                                        return (o = this.attributes.get('caption')) != null
                                            ? o
                                            : '';
                                    }),
                                    (h.prototype.isEqualTo = function (o) {
                            ...
                            (g.SplittableList = (function (o) {
                                ...
                                return (
                                    ...
                                    (e.prototype.splice = function () {
                                        ...
                                        return (
                                            ...
                                            new this.constructor(
                                                x.apply(null, [this.objects].concat(h.call(u))),
                                            )
                                        );
                                    }),
                                    (e.prototype.eachObject = function (u) {
                                        var s, n, p, c, v, t;
                                        for (
                                            v = this.objects, t = [], n = s = 0, p = v.length;
                                            p > s;
                                            n = ++s
                                        )
                                            (c = v[n]), t.push(u(c, n));
                                    ...
                                    (e.prototype.insertSplittableListAtPosition = function (u, s) {
                                        ...
                                        return (
                                            ...
                                            (p = c[0]),
                                            (n = c[1]),
                                            new this.constructor(p).insertSplittableListAtIndex(
                                                u,
                                                n,
                                            )
                                        );
                                    ...
                                    (e.prototype.selectSplittableList = function (u) {
                                        ...
                                        return (
                                            (n = function () {
                                                var p, c, v, t;
                                                for (
                                                    v = this.objects, t = [], p = 0, c = v.length;
                                                    c > p;
                                                    p++
                                                )
                                                    (s = v[p]), u(s) && t.push(s);
                                    ...
                                    (e.prototype.splitObjectsAtRange = function (u) {
                                        ...
                                        return (
                                            ...
                                            (s = c[1]),
                                            (p = c[2]),
                                            (v = new this.constructor(n).splitObjectAtPosition(
                                                a(u) + p,
                                            )),
                                            (n = v[0]),
                                            (t = v[1]),
                                    ...
                                    (e.prototype.findIndexAndOffsetAtPosition = function (u) {
                                        var s, n, p, c, v, t, r;
                                        for (
                                            s = 0, r = this.objects, p = n = 0, c = r.length;
                                            c > n;
                                            p = ++n
                                        ) {
                                            if (
                                    ...
                                    (e.prototype.findPositionAtIndexAndOffset = function (u, s) {
                                        var n, p, c, v, t, r;
                                        for (
                                            t = 0, r = this.objects, n = p = 0, c = r.length;
                                            c > p;
                                            n = ++p
                                        )
                                    ...
                                    (e.prototype.getEndPosition = function () {
                                        ...
                                        return this.endPosition != null
                                            ...
                                            : (this.endPosition = function () {
                                                  var n, p, c;
                                                  for (
                                                      s = 0, c = this.objects, n = 0, p = c.length;
                                                      p > n;
                                                      n++
                                                  )
                                                      (u = c[n]), (s += u.getLength());
                                    ...
                                    (e.prototype.isEqualTo = function (u) {
                                        return (
                                            e.__super__.isEqualTo.apply(this, arguments) ||
                                            d(this.objects, u?.objects)
                                        );
                                    }),
                                    (d = function (u, s) {
                                        var n, p, c, v, t;
                                        if ((s == null && (s = []), u.length !== s.length))
                                            return !1;
                        ...
                        g.Text = (function (y) {
                            ...
                            return (
                                ...
                                (h.prototype.copyUsingObjectMap = function (o) {
                                    ...
                                    return (
                                        (a = function () {
                                            var d, i, u, s, n;
                                            for (
                                                u = this.getPieces(), n = [], d = 0, i = u.length;
                                                i > d;
                                                d++
                                            )
                                ...
                                (h.prototype.removeTextAtRange = function (o) {
                                    return this.copyWithPieceList(
                                        this.pieceList.removeObjectsInRange(o),
                                    );
                                }),
                                ...
                                (h.prototype.getCommonAttributesAtRange = function (o) {
                                    var e;
                                    return (e = this.getTextAtRange(o).getCommonAttributes()) !=
                                        null
                                        ? e
                                        : {};
                                }),
                                (h.prototype.getExpandedRangeForAttributeAtOffset = function (
                                    o,
                                    e,
                                ) {
                                    var a, d, i;
                                    ...
                                    for (
                                        ;
                                        d > i && this.getCommonAttributesAtRange([e, i + 1])[o];
                                ...
                                (h.prototype.getTextAtRange = function (o) {
                                    return this.copyWithPieceList(
                                        this.pieceList.getSplittableListInRange(o),
                                    );
                                }),
                                ...
                                (h.prototype.endsWithString = function (o) {
                                    ...
                                    return (
                                        (e = this.getLength()),
                                        this.getStringAtRange([e - o.length, e]) === o
                                    );
                                }),
                                (h.prototype.getAttachmentPieces = function () {
                                    var o, e, a, d, i;
                                    for (
                                        d = this.pieceList.toArray(), i = [], o = 0, e = d.length;
                                        e > o;
                                        o++
                                    )
                                ...
                                (h.prototype.getAttachments = function () {
                                    var o, e, a, d, i;
                                    for (
                                        d = this.getAttachmentPieces(), i = [], o = 0, e = d.length;
                                        e > o;
                                        o++
                                    )
                                ...
                                (h.prototype.getAttachmentAndPositionById = function (o) {
                                    var e, a, d, i, u, s;
                                    for (
                                        i = 0, u = this.pieceList.toArray(), e = 0, a = u.length;
                                        a > e;
                                        e++
                                    ) {
                                        if (
                                ...
                                (h.prototype.updateAttributesForAttachment = function (o, e) {
                                    var a;
                                    return (a = this.getRangeOfAttachment(e))
                                        ? this.addAttributesAtRange(o, a)
                                        : this;
                                }),
                                (h.prototype.getLength = function () {
                            ...
                            (g.Block = (function (u) {
                                ...
                                return (
                                    ...
                                    (s.fromJSON = function (m) {
                                        var C;
                                        return (
                                            (C = g.Text.fromJSON(m.text)), new this(C, m.attributes)
                                        );
                                    }),
                                    ...
                                    (s.prototype.isEqualTo = function (m) {
                                        return (
                                            ...
                                            (this.text.isEqualTo(m?.text) &&
                                                x(this.attributes, m?.attributes))
                                        );
                                    }),
                                    ...
                                    (s.prototype.copyUsingObjectMap = function (m) {
                                        ...
                                        return this.copyWithText(
                                            (C = m.find(this.text))
                                                ? C
                                                : this.text.copyUsingObjectMap(m),
                                        );
                                    }),
                                    (s.prototype.addAttribute = function (m) {
                                        var C;
                                        return (
                                            (C = this.attributes.concat(v(m))),
                                    ...
                                    (s.prototype.getNestableAttributes = function () {
                                        var m, C, S, L, O;
                                        for (
                                            L = this.attributes, O = [], C = 0, S = L.length;
                                            S > C;
                                            C++
                                        )
                                    ...
                                    (s.prototype.increaseNestingLevel = function () {
                                        ...
                                        return (m = this.getLastNestableAttribute())
                                            ? ((S = this.attributes.lastIndexOf(m)),
                                              (C = o.apply(
                                                  null,
                                                  [this.attributes, S + 1, 0].concat(i.call(v(m))),
                                              )),
                                              this.copyWithAttributes(C))
                                            : this;
                                    }),
                                    ...
                                    (s.prototype.isListItem = function () {
                                        var m;
                                        return (m = y(this.getLastAttribute())) != null
                                            ? m.listAttribute
                                            : void 0;
                                    }),
                                    ...
                                    (s.prototype.findLineBreakInDirectionFromPosition = function (
                                        m,
                                        C,
                                    ) {
                                        var S, L;
                            ...
                            (g.HTMLSanitizer = (function (d) {
                                function i(c, v) {
                                    ...
                                    (t = v ?? {}),
                                        ...
                                        this.forbiddenProtocols == null &&
                                            (this.forbiddenProtocols = n),
                                        this.forbiddenElements == null &&
                                            (this.forbiddenElements = s),
                                        (this.body = p(c));
                                }
                                var u, s, n, p;
                                return (
                                    ...
                                    (i.prototype.sanitizeElements = function () {
                                        ...
                                        for (l = y(this.body), r = []; l.nextNode(); )
                                            switch (((t = l.currentNode), t.nodeType)) {
                                                case Node.ELEMENT_NODE:
                                                    this.elementIsRemovable(t)
                                                        ? r.push(t)
                                                        : this.sanitizeElement(t);
                                                    break;
                                                case Node.COMMENT_NODE:
                                                    r.push(t);
                                            }
                                        for (c = 0, v = r.length; v > c; c++)
                                            (t = r[c]), g.removeNode(t);
                                        return this.body;
                                    }),
                                    (i.prototype.sanitizeElement = function (c) {
                                        ...
                                        for (
                                            c.hasAttribute('href') &&
                                                ((l = c.protocol),
                                                e.call(this.forbiddenProtocols, l) >= 0 &&
                                    ...
                                    (i.prototype.normalizeListElementNesting = function () {
                                        var c, v, t, r, l;
                                        for (
                                            l = a.call(this.body.querySelectorAll('ul,ol')),
                                                c = 0,
                                                v = l.length;
                                            v > c;
                                            c++
                                    ...
                                    (i.prototype.elementIsRemovable = function (c) {
                                        return c?.nodeType === Node.ELEMENT_NODE
                                            ? this.elementIsForbidden(c) ||
                                                  this.elementIsntSerializable(c)
                                            : void 0;
                                    }),
                                    ...
                                    (i.prototype.elementIsntSerializable = function (c) {
                                        return (
                                            c.getAttribute('data-trix-serialize') === 'false' &&
                                            !x(c)
                                        );
                                    }),
                                    (p = function (c) {
                                ...
                                return (
                                        ...
                                        try {
                                            for (
                                                this.createHiddenContainer(),
                                                    w = g.HTMLSanitizer.sanitize(
                                                        this.html,
                                                    ).getHTML(),
                                                    this.containerElement.innerHTML = w,
                                                    k = s(this.containerElement, {
                                                        usingFilter: S,
                                                    });
                                                k.nextNode();
                                        ...
                                        switch (w.nodeType) {
                                            case Node.TEXT_NODE:
                                                if (!this.isInsignificantTextNode(w))
                                                    return (
                                                        this.appendBlockForTextNode(w),
                                                        this.processTextNode(w)
                                                    );
                                                break;
                                            case Node.ELEMENT_NODE:
                                                return (
                                                    this.appendBlockForElement(w),
                                                    this.processElement(w)
                                                );
                                        }
                                    }),
                                    (t.prototype.appendBlockForTextNode = function (w) {
                                        ...
                                        return (
                                            ...
                                            this.isBlockElement(w.previousSibling)
                                                ? this.appendStringWithAttributes(`
`)
                                                : (T !== this.containerElement &&
                                                        !this.isBlockElement(T)) ||
...
`)
                                    ...
                                    (t.prototype.findParentBlockElement = function (w) {
                                        ...
                                        for (
                                            k = w.parentElement;
                                            k && k !== this.containerElement;

                                        ) {
                                            if (
                                                this.isBlockElement(k) &&
                                                c.call(this.blockElements, k) >= 0
                                            )
                                                return k;
                                            k = k.parentElement;
                                        }
                                    ...
                                    (t.prototype.processTextNode = function (w) {
                                        ...
                                        return (
                                            ...
                                            l(w.parentNode) ||
                                                ((T = i(T)),
                                                R(
                                                    (k = w.previousSibling) != null
                                                        ? k.textContent
                                                        : void 0,
                                                ) && (T = m(T))),
                                            this.appendStringWithAttributes(
                                                T,
                                                this.getTextAttributes(w.parentNode),
                                            )
                                        );
                                    }),
...
`);
                                    ...
                                    (t.prototype.appendBlockForAttributesWithElement = function (
                                        w,
                                        k,
                                    ) {
                                        var T;
                                        return (
                                            this.blockElements.push(k),
                                            (T = r(w)),
                                            this.blocks.push(T),
                                            T
                                        );
                                                ...
                                                (N = P[k]),
                                                    N.parse !== !1 &&
                                                        ...
                                                        ((typeof N.test == 'function' &&
                                                            ...
                                                            !N.test) &&
                                                        (T.push(k),
                                                        N.listAttribute && T.push(N.listAttribute));
                                            w = w.parentNode;
                                        }
                                        return T.reverse();
                                    }),
                                    ...
                                    (t.prototype.isBlockElement = function (w) {
                                        ...
                                        if (
                                            ...
                                            return (
                                                (k = u(w)),
                                                c.call(o(), k) >= 0 ||
                                                    window.getComputedStyle(w).display === 'block'
                                            );
                                    }),
...
`,
                                    ...
                                    (t.prototype.getMarginOfBlockElementAtIndex = function (w) {
                                        ...
                                        return !(k = this.blockElements[w]) ||
                                            ...
                                            ((T = u(k)),
                                            c.call(o(), T) >= 0 ||
                                                c.call(this.processedElements, k) >= 0)
                                            ? void 0
                                            : A(k);
                                    }),
                                    ...
                                    (A = function (w) {
                                        ...
                                        return (
                                            ...
                                            k.display === 'block'
                                                ? {
                                                      top: parseInt(k.marginTop),
                                                      bottom: parseInt(k.marginBottom),
                                                  }
                                                : void 0
                                        );
                                    }),
                            ...
                            (g.Document = (function (i) {
                                ...
                                return (
                                    ...
                                    (u.fromString = function (n, p) {
                                        var c;
                                        return (
                                            (c = g.Text.textForStringWithAttributes(n, p)),
                                            new this([new g.Block(c)])
                                        );
                                    }),
                                    (u.prototype.isEmpty = function () {
                                        ...
                                        return (
                                            ...
                                            ((n = this.getBlockAtIndex(0)),
                                            n.isEmpty() && !n.hasAttributes())
                                        );
                                    }),
                                    ...
                                    (u.prototype.copyUsingObjectsFromDocument = function (n) {
                                        var p;
                                        return (
                                            (p = new g.ObjectMap(n.getObjects())),
                                            this.copyUsingObjectMap(p)
                                        );
                                    }),
                                    ...
                                    (u.prototype.replaceBlock = function (n, p) {
                                        ...
                                        return (
                                            ...
                                            c === -1
                                                ? this
                                                : new this.constructor(
                                                      this.blockList.replaceObjectAtIndex(p, c),
                                                  )
                                        );
                                    }),
                                        ...
                                        return (
                                            ...
                                            h(p) && c.isEmpty() && !c.hasAttributes()
                                                ? (f = new this.constructor(
                                                      f.blockList.removeObjectAtIndex(t),
                                                  ))
                                                : c.getBlockBreakPosition() === r && l++,
                                            (f = f.removeTextAtRange(p)),
                                            new this.constructor(
                                                f.blockList.insertSplittableListAtPosition(v, l),
                                            )
                                        );
                                    }),
                                        ...
                                        return (
                                            ...
                                            new this.constructor(
                                                c.blockList.editObjectAtIndex(v, function (A) {
                                                    return A.copyWithText(
                                                        A.text.insertTextAtPosition(n, t),
                                                    );
                                                }),
                                            )
                                        );
...
`),
                                                  L
                                                      ? (v = this.blockList.editObjectAtIndex(
                                                            R,
                                                            function (_) {
                                                                return _.copyWithText(
                                                                    _.text.removeTextAtRange([
                                                                        w,
                                                                        w + 1,
                                                                    ]),
                                                                );
                                                ...
                                                return (v = v.editObjectAtIndex(l, function () {
                                                    return b(n)
                                                        ...
                                                        : r[0] === r[1]
                                                          ? t
                                                          : t.copyWithText(
                                                                t.text.addAttributeAtRange(n, p, r),
                                                            );
                                                }));
                                            }),
                                            new this.constructor(v)
                                        ...
                                        return (
                                            ...
                                            this.eachBlockAtRange(p, function (v, t, r) {
                                                return b(n)
                                                    ...
                                                    : t[0] !== t[1]
                                                      ? (c = c.editObjectAtIndex(r, function () {
                                                            return v.copyWithText(
                                                                v.text.removeAttributeAtRange(n, t),
                                                            );
                                                        }))
                                                      : void 0;
                                            }),
                                        ...
                                        return (
                                            ...
                                            new this.constructor(
                                                this.blockList.editObjectAtIndex(c, function (l) {
                                                    return l.copyWithText(
                                                        r.updateAttributesForAttachment(n, p),
                                                    );
                                                }),
                                            )
                                        );
                                    ...
                                    (u.prototype.removeAttributeForAttachment = function (n, p) {
                                        var c;
                                        return (
                                            (c = this.getRangeOfAttachment(p)),
                                            this.removeAttributeAtRange(n, c)
                                        );
                                    }),
                                    (u.prototype.insertBlockBreakAtRange = function (n) {
                                        ...
                                        return (
                                            ...
                                            v === 0 && (p = [new g.Block()]),
                                            new this.constructor(
                                                c.blockList.insertSplittableListAtPosition(
                                                    new g.SplittableList(p),
                                                    t,
                                                ),
                                            )
                                        );
                                    ...
                                    (u.prototype.expandRangeToLineBreaksAndSplitBlocks = function (
                                        n,
                                    ) {
                                        ...
                                        return (
                                            ...
                                            (f.offset = A.findLineBreakInDirectionFromPosition(
                                                'backward',
                                                f.offset,
                                            )) != null &&
                                            ...
                                            v.offset === 0 && v.index > f.index
                                                ? ((v.index -= 1),
                                                  (v.offset = p
                                                      .getBlockAtIndex(v.index)
                                                      .getBlockBreakPosition()))
                                                : ((c = p.getBlockAtIndex(v.index)),
                                                  c.text.getStringAtRange([
                                                      v.offset - 1,
                                                      v.offset,
                                                  ]) ===
                                                  `
`
                                                      ? (v.offset -= 1)
                                                      : (v.offset =
                                                            c.findLineBreakInDirectionFromPosition(
                                                                'forward',
                                                                v.offset,
                                                            )),
                                    ...
                                    (u.prototype.convertLineBreaksToBlockBreaksInRange = function (
                                        n,
                                    ) {
                                        var p, c, v;
                                        return (
                                            ...
                                            v.replace(/.*?\n/g, function (t) {
                                                return (
                                                    (c += t.length),
                                                    (p = p.insertBlockBreakAtRange([c - 1, c]))
                                                );
                                            }),
                                            { document: p, range: n }
                                        );
                                    ...
                                    (u.prototype.consolidateBlocksAtRange = function (n) {
                                        ...
                                        return (
                                            ...
                                            new this.constructor(
                                                this.blockList.consolidateFromIndexToIndex(t, p),
                                            )
                                        );
                                    }),
                                    ...
                                    (u.prototype.getBlockAtPosition = function (n) {
                                        var p;
                                        return (
                                            (p = this.locationFromPosition(n).index),
                                            this.getBlockAtIndex(p)
                                        );
                                    }),
                                    (u.prototype.getTextAtIndex = function (n) {
                                        var p;
                                        return (p = this.getBlockAtIndex(n)) != null
                                            ? p.text
                                            : void 0;
                                    }),
                                            ...
                                            h(n)
                                                ...
                                                : ((v = []),
                                                  ...
                                                  this.eachBlockAtRange(n, function (t, r) {
                                                      return r[0] !== r[1]
                                                          ? (v.push(
                                                                t.text.getCommonAttributesAtRange(
                                                                    r,
                                                                ),
                                                            ),
                                                            p.push(s(t)))
                                                  ...
                                                  g.Hash.fromCommonAttributesOfObjects(v)
                                                      .merge(
                                                          g.Hash.fromCommonAttributesOfObjects(p),
                                                      )
                                                      .toObject())
                                        );
                                    }),
                                    (u.prototype.getCommonAttributesAtPosition = function (n) {
                                        ...
                                        for (A in c)
                                            (C = c[A]),
                                                (C === p[A] || d.call(l, A) >= 0) && (t[A] = C);
                                        return t;
                                    }),
                                    (u.prototype.getRangeOfCommonAttributeAtPosition = function (
                                        n,
                                        p,
                                    ) {
                                    ...
                                    (s = function (n) {
                                        var p, c;
                                        return (
                                            (c = {}), (p = n.getLastAttribute()) && (c[p] = !0), c
                                        );
                                    }),
                                    (u.prototype.getAttachmentById = function (n) {
                                        var p, c, v, t;
                                        for (
                                            t = this.getAttachments(), c = 0, v = t.length;
                                            v > c;
                                            c++
                                        )
                                    ...
                                    (u.prototype.getAttachmentPieces = function () {
                                        ...
                                        return (
                                            ...
                                            this.blockList.eachObject(function (p) {
                                                ...
                                                return (
                                                    (c = p.text),
                                                    (n = n.concat(c.getAttachmentPieces()))
                                                );
                                            }),
                                            n
                                        );
                                    ...
                                    (u.prototype.getLocationRangeOfAttachment = function (n) {
                                        var p;
                                        return (
                                            (p = this.getRangeOfAttachment(n)),
                                            this.locationRangeFromRange(p)
                                        );
                                    }),
                                    (u.prototype.getAttachmentPieceForAttachment = function (n) {
                                        var p, c, v, t;
                                        for (
                                            t = this.getAttachmentPieces(), p = 0, c = t.length;
                                            c > p;
                                            p++
                                        )
                                    ...
                                    (u.prototype.locationFromPosition = function (n) {
                                        var p, c;
                                        return (
                                            (c = this.blockList.findIndexAndOffsetAtPosition(
                                                Math.max(0, n),
                                            )),
                                            c.index != null
                                                ? c
                                    ...
                                    (u.prototype.getTexts = function () {
                                        var n, p, c, v, t;
                                        for (
                                            v = this.getBlocks(), t = [], p = 0, c = v.length;
                                            c > p;
                                            p++
                                        )
                                            (n = v[p]), t.push(n.text);
                                    ...
                                    (u.prototype.getPieces = function () {
                                        var n, p, c, v, t;
                                        for (
                                            c = [], v = this.getTexts(), n = 0, p = v.length;
                                            p > n;
                                            n++
                                        )
                                    ...
                                    (u.prototype.toSerializableDocument = function () {
                                        ...
                                        return (
                                            ...
                                            this.blockList.eachObject(function (p) {
                                                return n.push(
                                                    p.copyWithText(p.text.toSerializableText()),
                                                );
                                            }),
                                            new this.constructor(n)
                                        );
                                        ...
                                        return JSON.stringify(
                                            function () {
                                                ...
                                                for (
                                                    ...
                                                    (n = v[p]),
                                                        t.push(JSON.parse(n.text.toConsole()));
                                                return t;
                                            }.call(this),
                                        );
                                    }),
                                ...
                                return (
                                    ...
                                    (c.prototype.loadSnapshot = function (t) {
                                        ...
                                        return (
                                            ...
                                            (f = t.selectedRange),
                                            (l = this.delegate) != null &&
                                                typeof l.compositionWillLoadSnapshot ==
                                                    'function' &&
                                    ...
                                    (c.prototype.insertDocument = function (t) {
                                        ...
                                        return (
                                            ...
                                            (l = this.getSelectedRange()),
                                            this.setDocument(
                                                this.document.insertDocumentAtRange(t, l),
                                            ),
                                            (A = l[0]),
                                            (r = A + t.getLength()),
                                            this.setSelection(r),
                                    ...
                                    (c.prototype.insertBlockBreak = function () {
                                        ...
                                        return (
                                            ...
                                            this.setDocument(
                                                this.document.insertBlockBreakAtRange(r),
                                            ),
                                            (l = r[0]),
                                            (t = l + 1),
                                            this.setSelection(t),
                                        ...
                                        return (
                                            ...
                                            r.shouldDecreaseListLevel()
                                                ? (this.decreaseListLevel(),
                                                  this.setSelection(r.startPosition))
                                                : r.shouldPrependListItem()
                                                  ? ((t = new g.Document([
                                                        r.block.copyWithoutText(),
                                                    ])),
...
`)
                                    ...
                                    (c.prototype.insertHTML = function (t) {
                                        ...
                                        return (
                                            ...
                                            (A = this.getSelectedRange()),
                                            this.setDocument(
                                                this.document.mergeDocumentAtRange(r, A),
                                            ),
                                            (f = A[0]),
                                            (l = f + r.getLength() - 1),
                                            this.setSelection(l),
                                        ...
                                        for (l = [], f = 0, m = t.length; m > f; f++)
                                            (A = t[f]),
                                                (C = this.delegate) != null &&
                                                    ...
                                                    ((r = g.Attachment.attachmentForFile(A)),
                                                    l.push(r));
                                    ...
                                    (c.prototype.moveTextFromRange = function (t) {
                                        ...
                                        return (
                                            ...
                                            this.setDocument(
                                                this.document.moveTextFromRangeToPosition(t, r),
                                            ),
                                            this.setSelection(r)
                                        );
                                    }),
                                    ...
                                    (c.prototype.hasCurrentAttribute = function (t) {
                                        var r;
                                        return (
                                            (r = this.currentAttributes[t]), r != null && r !== !1
                                        );
                                    }),
                                    ...
                                    (c.prototype.canSetCurrentTextAttribute = function () {
                                        ...
                                        if ((r = this.getSelectedDocument())) {
                                            for (
                                                f = r.getAttachments(), l = 0, A = f.length;
                                                A > l;
                                                l++
                                            )
                                    ...
                                    (c.prototype.setTextAttribute = function (t, r) {
                                        ...
                                        if ((A = this.getSelectedRange()))
                                            return (
                                                ...
                                                f !== l
                                                    ? this.setDocument(
                                                          this.document.addAttributeAtRange(
                                                              t,
                                                              r,
                                                              A,
                                                          ),
                                                    ...
                                                    : t === 'href'
                                                      ? ((m = g.Text.textForStringWithAttributes(
                                                            r,
                                                            { href: r },
                                                        )),
                                                        this.insertText(m))
                                    ...
                                    (c.prototype.removeTextAttribute = function (t) {
                                        ...
                                        if ((r = this.getSelectedRange()))
                                            return this.setDocument(
                                                this.document.removeAttributeAtRange(t, r),
                                            );
                                    }),
                                    ...
                                    (c.prototype.canIncreaseNestingLevel = function () {
                                        var t, r, l;
                                        if ((t = this.getBlock()))
                                            return (l = h(t.getLastNestableAttribute())) != null &&
                                                l.listAttribute
                                                ? (r = this.getPreviousBlock())
                                                    ? x(
                                                          r.getListItemAttributes(),
                                    ...
                                    (c.prototype.decreaseListLevel = function () {
                                        ...
                                        for (
                                            ...
                                            l++;
                                        return (
                                            (m = this.document.positionFromLocation({
                                                index: f,
                                                offset: 0,
                                            })),
                                            (A = this.document.positionFromLocation({
                                                index: l,
                                                offset: 0,
                                            })),
                                            this.setDocument(
                                    ...
                                    (c.prototype.setSelection = function (t) {
                                        ...
                                        return (
                                            ...
                                            (l = this.delegate) != null
                                                ? l.compositionDidRequestChangingSelectionToLocationRange(
                                                      r,
                                                  )
                                                : void 0
                                        );
                                    ...
                                    (c.prototype.withTargetDOMRange = function (t, r) {
                                        var l;
                                        return (
                                            (l = this.createLocationRangeFromDOMRange(t, {
                                                strict: !1,
                                            })),
                                            this.withTargetLocationRange(l, r)
                                        );
                                    ...
                                    (c.prototype.getExpandedRangeInDirection = function (t, r) {
                                        ...
                                        return (
                                            ...
                                            t === 'backward'
                                                ? A
                                                    ? (m -= A)
                                                    : (m = this.translateUTF16PositionFromOffset(
                                                          m,
                                                          -1,
                                                      ))
                                                : A
                                                  ? (l += A)
                                                  : (l = this.translateUTF16PositionFromOffset(
                                                        l,
                                                        1,
                                                    )),
                                            e([m, l])
                                    ...
                                    (c.prototype.shouldManageMovingCursorInDirection = function (
                                        t,
                                    ) {
                                        var r;
                                    ...
                                    (c.prototype.moveCursorInDirection = function (t) {
                                        ...
                                        return (
                                            this.editingAttachment
                                                ? (A = this.document.getRangeOfAttachment(
                                                      this.editingAttachment,
                                                  ))
                                                : ((f = this.getSelectedRange()),
                                            ...
                                            l && (r = this.getAttachmentAtRange(A))
                                                ? this.editAttachment(r)
                                                : void 0
                                        );
                                    }),
                                    ...
                                    (c.prototype.expandSelectionAroundCommonAttribute = function (
                                        t,
                                    ) {
                                        var r, l;
                                        return (
                                            (r = this.getPosition()),
                                            (l = this.document.getRangeOfCommonAttributeAtPosition(
                                                t,
                                                r,
                                            )),
                                    ...
                                    (c.prototype.selectionContainsAttachments = function () {
                                        var t;
                                        return (
                                            ((t = this.getSelectedAttachments()) != null
                                                ? t.length
                                                : void 0) > 0
                                        );
                                    }),
                                    ...
                                    (c.prototype.getSelectedAttachments = function () {
                                        var t;
                                        return (t = this.getSelectedDocument()) != null
                                            ? t.getAttachments()
                                            : void 0;
                                    }),
                                    ...
                                    (c.prototype.refreshAttachments = function () {
                                        ...
                                        for (
                                            ...
                                            (r = D[A]),
                                                (r.delegate = null),
                                                (L = this.delegate) != null &&
                                                    typeof L.compositionDidRemoveAttachment ==
                                                        'function' &&
                                        ...
                                        for (R = [], f = 0, C = t.length; C > f; f++)
                                            (r = t[f]),
                                                ...
                                                R.push(
                                                    (O = this.delegate) != null &&
                                                        typeof O.compositionDidAddAttachment ==
                                                            'function'
                                    ...
                                    (c.prototype.attachmentDidChangePreviewURL = function (t) {
                                        ...
                                        return (
                                            this.revision++,
                                            (r = this.delegate) != null &&
                                            typeof r.compositionDidChangeAttachmentPreviewURL ==
                                                'function'
                                    ...
                                    (c.prototype.editAttachment = function (t, r) {
                                        ...
                                        if (t !== this.editingAttachment)
                                            return (
                                                ...
                                                (l = this.delegate) != null &&
                                                typeof l.compositionDidStartEditingAttachment ==
                                                    'function'
                                                    ? l.compositionDidStartEditingAttachment(
                                                          this.editingAttachment,
                                                          r,
                                                      )
                                                    : void 0
                                    ...
                                    (c.prototype.updateAttributesForAttachment = function (t, r) {
                                        return this.setDocument(
                                            this.document.updateAttributesForAttachment(t, r),
                                        );
                                    }),
                                    (c.prototype.removeAttributeForAttachment = function (t, r) {
                                        return this.setDocument(
                                            this.document.removeAttributeForAttachment(t, r),
                                        );
                                    }),
...
`
                                            ...
                                            (A = new g.Document([
                                                r.removeLastAttribute().copyWithoutText(),
                                            ])),
                                    ...
                                    (c.prototype.getPreviousBlock = function () {
                                        var t, r;
                                        return (r = this.getLocationRange()) &&
                                            ((t = r[0].index), t > 0)
...
`
                                    ...
                                    (c.prototype.notifyDelegateOfCurrentAttributesChange =
                                        function () {
                                            var t;
                                            return (t = this.delegate) != null &&
                                    ...
                                    (c.prototype.notifyDelegateOfInsertionAtRange = function (t) {
                                        var r;
                                        return (r = this.delegate) != null &&
                                            typeof r.compositionDidPerformInsertionAtRange ==
                                                'function'
                                            ? r.compositionDidPerformInsertionAtRange(t)
                                            : void 0;
                                    }),
                                    (c.prototype.translateUTF16PositionFromOffset = function (
                                        t,
                                        r,
                                    ) {
                                        var l, A;
                    ...
                    function () {
                        ...
                        g.UndoManager = (function (y) {
                            ...
                            return (
                                ...
                                (o = function (e, a, d) {
                                    return (
                                        e?.description === a?.toString() &&
                                        e?.context === JSON.stringify(d)
                                    );
                                }),
                                h
                            );
                                    ...
                                    (b.prototype.removeBlockAttribute = function () {
                                        ...
                                        for (
                                            ...
                                            (d = i[e]),
                                                u.push(
                                                    (this.document =
                                                        this.document.removeAttributeAtRange(y, d)),
                                                );
                                        return u;
                                    }),
...
` &&
                                                        ((this.document =
                                                            this.document.insertBlockBreakAtRange(
                                                                i[1],
                                                            )),
...
` &&
                                    ...
                                    (b.prototype.findRangesOfPieces = function () {
                                        return this.document.findRangesForTextAttribute(h, {
                                            withValue: o,
                                        });
                                    }),
                        ...
                        g.Editor = (function () {
                            ...
                            return (
                                ...
                                (b.prototype.activateAttribute = function (h, o) {
                                    return (
                                        o == null && (o = !0),
                                        this.composition.setCurrentAttribute(h, o)
                                    );
                                }),
                                ...
                                (b.prototype.recordUndoEntry = function (h, o) {
                                    ...
                                    return (
                                        ...
                                        (a = d.context),
                                        (e = d.consolidatable),
                                        this.undoManager.recordUndoEntry(h, {
                                            context: a,
                                            consolidatable: e,
                                        })
                                    );
                        ...
                        g.AttachmentManager = (function (y) {
                            ...
                            return (
                                ...
                                (h.prototype.unmanageAttachment = function (o) {
                                    var e;
                                    return (
                                        (e = this.managedAttachments[o.id]),
                                        delete this.managedAttachments[o.id],
                                        e
                                    );
                                }),
                                h
                    ...
                    function () {
                        ...
                        (x = g.elementContainsNode),
                            ...
                            (g.LocationMapper = (function () {
                                ...
                                var p, c, v, t;
                                return (
                                    (n.prototype.findLocationFromContainerAndOffset = function (
                                        r,
                                        l,
                                        A,
                                    ) {
                                    ...
                                    (n.prototype.findContainerAndOffsetFromLocation = function (r) {
                                        ...
                                        if (
                                            ((C = this.findNodeAndOffsetFromLocation(r)),
                                            (A = C[0]),
                                            (f = C[1]),
                                            A)
                                        ) {
                                            if (i(A))
                                                ...
                                                if (
                                                    ((l = A.parentNode),
                                                    !o(A.previousSibling) && !h(l))
                                                )
                                                    for (
                                                        ;
                                                        A === l.lastChild &&
                                                        ((A = l), (l = l.parentNode), !h(l));
                                    ...
                                    (n.prototype.findNodeAndOffsetFromLocation = function (r) {
                                        ...
                                        for (
                                            L = 0,
                                                O = this.getSignificantNodesForIndex(r.index),
                                                A = 0,
                                                f = O.length;
                                            f > A;
                                            A++
                                    ...
                                    (p = function (r) {
                                        return t(r) === NodeFilter.FILTER_ACCEPT
                                            ? v(r)
                                            : NodeFilter.FILTER_REJECT;
                                    }),
                                    (t = function (r) {
                                ...
                                return (
                                    (h.prototype.createDOMRangeFromPoint = function (o) {
                                        ...
                                        if (document.caretRangeFromPoint)
                                            return document.caretRangeFromPoint(n, p);
                        ...
                        (x = g.getDOMRange),
                            (g.SelectionChangeObserver = (function (e) {
                                ...
                                return (
                                    ...
                                    (a.prototype.notifySelectionManagersOfSelectionChange =
                                        function () {
                                            var i, u, s, n, p;
                                            for (
                                                s = this.selectionManagers,
                                                    n = [],
                                                    i = 0,
                                                    u = s.length;
                                                u > i;
                                ...
                                return (
                                    ...
                                    (v.prototype.getLocationRange = function (t) {
                                        ...
                                        return (
                                            ...
                                            (r =
                                                t.strict === !1
                                                    ? this.createLocationRangeFromDOMRange(b(), {
                                                          strict: !1,
                                                      })
                                                    : t.ignoreLock
                                            ...
                                            (r = (function (f) {
                                                return function () {
                                                    ...
                                                    for (
                                                        ...
                                                        (m = l[C]), m.destroy();
                                                    return x(document, f.element)
                                                        ? f.selectionDidChange()
                                                        : void 0;
                                                };
                                            })(this)),
                                            (A = setTimeout(r, 200)),
                                    ...
                                    (v.prototype.createDOMRangeFromLocationRange = function (t) {
                                        ...
                                        return (
                                            ...
                                            (l = d(t)
                                                ? A
                                                : (f = this.findContainerAndOffsetFromLocation(
                                                        t[1],
                                                    )) != null
                                                  ? f
                                                  : A),
                            ...
                            (g.EditorController = (function (d) {
                                function i(s) {
                                    ...
                                    (this.editorElement = s.editorElement),
                                        (n = s.document),
                                        (p = s.html),
                                        (this.selectionManager = new g.SelectionManager(
                                            this.editorElement,
                                        )),
                                        ...
                                        n != null
                                            ...
                                            : this.editor.loadHTML(p);
                                }
                                var u;
                                return (
                                    o(i, d),
                                    (i.prototype.registerSelectionManager = function () {
                                        return g.selectionChangeObserver.registerSelectionManager(
                                            this.selectionManager,
                                        );
                                    }),
                                    ...
                                    (i.prototype.compositionDidChangeCurrentAttributes = function (
                                        s,
                                    ) {
                                        return (
                                    ...
                                    (i.prototype.compositionDidPerformInsertionAtRange = function (
                                        s,
                                    ) {
                                    ...
                                    (i.prototype.compositionDidChangeAttachmentPreviewURL =
                                        function (s) {
                                            return (
                                    ...
                                    (i.prototype.compositionDidStartEditingAttachment = function (
                                        s,
                                        n,
                                    ) {
                                        return (
                                    ...
                                    (i.prototype.compositionDidRequestChangingSelectionToLocationRange =
                                        function (s) {
                                    ...
                                    (i.prototype.attachmentManagerDidRequestRemovalOfAttachment =
                                        function (s) {
                                            return this.removeAttachment(s);
                                        }),
                                    (i.prototype.compositionControllerWillSyncDocumentView =
                                        function () {
                                            return (
                                    ...
                                    (i.prototype.compositionControllerDidSyncDocumentView =
                                        function () {
                                            return (
                                    ...
                                    (i.prototype.compositionControllerDidSelectAttachment =
                                        function (s, n) {
                                            return (
                                                this.toolbarController.hideDialog(),
                                                this.composition.editAttachment(s, n)
                                            );
                                        }),
                                    (i.prototype.compositionControllerDidRequestDeselectingAttachment =
                                        function (s) {
                                            var n, p;
                                            return (
                                                (n =
                                    ...
                                    (i.prototype.compositionControllerWillUpdateAttachment =
                                        function (s) {
                                    ...
                                    (i.prototype.compositionControllerDidRequestRemovalOfAttachment =
                                        function (s) {
                                            return this.removeAttachment(s);
                                        }),
                                    ...
                                    (i.prototype.inputControllerDidAllowUnhandledInput =
                                        function () {
                                    ...
                                    (i.prototype.inputControllerWillPerformFormatting = function (
                                        s,
                                    ) {
                                    ...
                                    (i.prototype.inputControllerDidReceiveKeyboardCommand =
                                        function (s) {
                                    ...
                                    (i.prototype.inputControllerDidReceiveDragOverPoint = function (
                                        s,
                                    ) {
                                    ...
                                    (i.prototype.actions = {
                                        ...
                                        attachFiles: {
                                            ...
                                            perform: function () {
                                                return g.config.input.pickFiles(
                                    ...
                                    (u = function (s, n) {
                                        return (
                                            h(s.selectedRange, n.selectedRange) &&
                                            s.document.isEqualTo(n.document)
                                        );
                                    }),
                                    ...
                                    (i.prototype.getLocationContext = function () {
                                        var s;
                                        return (
                                            (s = this.selectionManager.getLocationRange()),
                                            y(s) ? s[0].index : s
                                        );
                                    }),
                                    (i.prototype.getTimeContext = function () {
                                        return g.config.undoInterval > 0
                                            ? Math.floor(
                                                  new Date().getTime() / g.config.undoInterval,
                                              )
                                            : 0;
                                    }),
                                    (i.prototype.isFocused = function () {
                                        ...
                                        return (
                                            this.editorElement ===
                                            ((s = this.editorElement.ownerDocument) != null
                                                ? s.activeElement
                                                : void 0)
                                        );
                                    }),
                            ...
                            g.registerElement(
                                ...
                                (function () {
                                    ...
                                    return (
                                        ...
                                        (p = function (l) {
                                            return typeof document.queryCommandSupported ==
                                                'function' &&
                                        ...
                                        (c = function (l) {
                                            ...
                                            if (
                                                ...
                                                !l.hasAttribute('aria-labelledby')
                                            )
                                                return (
                                                    (A = function () {
                                                        var f, m, C;
...
%t [data-trix-cursor-target=right] {
  ...
  margin-right: -1px !important;
                                            ...
                                            editor: {
                                                get: function () {
                                                    var l;
                                                    return (l = this.editorController) != null
                                                        ? l.editor
                                                        : void 0;
                                                },
                                            },
                                            name: {
                                                get: function () {
                                                    var l;
                                                    return (l = this.inputElement) != null
                                                        ? l.name
                                                        : void 0;
                                                },
                                            },
                                            ...
                                            setInputElementValue: function (l) {
                                                var A;
                                                return (A = this.inputElement) != null
                                                    ? (A.value = l)
                                                    : void 0;
                                            },
                                            initialize: function () {
                                            ...
                                            connect: function () {
                                                return this.hasAttribute('data-trix-internal')
                                                    ...
                                                    : (this.editorController ||
                                                          (a('trix-before-initialize', {
                                                              onElement: this,
                                                          }),
                                                          (this.editorController =
                                                              new g.EditorController({
                                                                  editorElement: this,
...
W.default.config.blockAttributes.heading = {
    tagName: 'h2',
    terminal: !0,
    breakOnReturn: !0,
    group: !1,
};
W.default.config.blockAttributes.subHeading = {
    tagName: 'h3',
    terminal: !0,
    breakOnReturn: !0,
    group: !1,
